        ...
        _ =
          :logger_server.do_internal_log(
            ...
            %{
              ...
              line: 158,
              file: ~c"otp/lib/kernel/src/logger_proxy.erl"
            },
            %{},
            [~c"~w switched from ~w to ~w mode", [:logger_proxy, mode0, mode1]]
          )
      ...
      true ->
        _ =
          :logger_server.do_internal_log(
            ...
            %{},
            [~c"~w flushed ~w log events", [:logger_proxy, flushed]]
          )
