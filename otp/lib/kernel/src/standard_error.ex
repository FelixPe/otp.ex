defmodule :m_standard_error do
  ...
  defp check_valid_opts([{:onlcr, bool} | t]) when is_boolean(bool) do
    check_valid_opts(t)
  end
  ...
  defp expand_encoding([:utf8 | t]) do
    [{:encoding, :unicode} | expand_encoding(t)]
  end

  defp expand_encoding([{:encoding, :utf8} | t]) do
    [{:encoding, :unicode} | expand_encoding(t)]
  end
