defmodule :m_xref_scanner do
  ...
  defp lex([{:atom, n, v1}, {:"->", _}, {:atom, _, v2} |
                                        l]) do
    constant = {:constant, :unknown, :edge, {v1, v2}}
    [{:edge, n, constant} | lex(l)]
  end

  defp lex([{:"{", n}, {:atom, _, v1}, {:",", _}, {:atom, _,
                                                v2},
                                                 {:"}", _} | l]) do
    constant = {:constant, :unknown, :edge, {v1, v2}}
    [{:edge, n, constant} | lex(l)]
  ...
  defp lex([{:atom, n, m}, {:":", _}, {:atom, _, f}, {:"/", _},
                                                      {:integer, _, a}, {:"->", _},
                                                                            {:atom,
                                                                               _,
                                                                               m2},
  ...
  defp lex([{:"{", n}, {:atom, _, m}, {:",", _}, {:atom, _, f},
                                                {:",", _}, {:integer, _, a}, {:"}",
                                                                              _} |
                                                                               l]) do
    constant = {:constant, :Fun, :vertex, {m, f, a}}
