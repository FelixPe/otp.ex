defmodule :m_mnesia_rpc do
  ...
  def handle_call(msg, _From, state) do
    :mnesia_lib.error(~c"~p got unexpected call: ~tp~n", [:mnesia_rpc, msg])
    {:reply, :badop, state}
  end

  def handle_cast(msg, state) do
    :mnesia_lib.error(~c"~p got unexpected cast: ~tp~n", [:mnesia_rpc, msg])
    {:noreply, state}
  end

  def handle_info(msg, state) do
    :mnesia_lib.error(~c"~p got unexpected info: ~tp~n", [:mnesia_rpc, msg])
    {:noreply, state}
  end
