defmodule :m_pubkey_pbe do
  ...
  def encode(data, password, ~c"DES-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:des_cbc, key, iV, pbe_pad(data, block_size(:des_cbc)), true)
  end

  def encode(data, password, ~c"DES-EDE3-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
  ...
  def encode(data, password, ~c"RC2-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:rc2_cbc, key, iV, pbe_pad(data, block_size(:rc2_cbc)), true)
  end

  def encode(data, password, ~c"AES-128-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:aes_128_cbc, key, iV, pbe_pad(data, block_size(:aes_128_cbc)), true)
  end

  def encode(data, password, ~c"AES-192-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:aes_192_cbc, key, iV, pbe_pad(data, block_size(:aes_192_cbc)), true)
  end

  def encode(data, password, ~c"AES-256-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:aes_256_cbc, key, iV, pbe_pad(data, block_size(:aes_256_cbc)), true)
  end

  def decode(data, password, ~c"DES-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:des_cbc, key, iV, data, false)
  end

  def decode(data, password, ~c"DES-EDE3-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:des_ede3_cbc, key, iV, data, false)
  end

  def decode(data, password, ~c"RC2-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:rc2_cbc, key, iV, data, false)
  end

  def decode(data, password, ~c"AES-128-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:aes_128_cbc, key, iV, data, false)
  end

  def decode(data, password, ~c"AES-192-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
    :crypto.crypto_one_time(:aes_192_cbc, key, iV, data, false)
  end

  def decode(data, password, ~c"AES-256-CBC" = cipher, keyDevParams) do
    {key, iV} = password_to_key_and_iv(password, cipher, keyDevParams)
