defmodule :m_cerl_clauses do
  ...
  import :cerl, only: [alias_pat: 1, alias_var: 1,
                         clause_guard: 1, clause_pats: 1, concrete: 1,
                         data_arity: 1, data_es: 1, data_type: 1, is_c_var: 1,
                         is_data: 1, let_body: 1, letrec_body: 1, seq_body: 1,
                         try_arg: 1, type: 1, values_es: 1]
