defmodule :m_beam_utils do
  ...
  defp replace_labels_1([{:call_fun2, {:f, lbl}, ar, func} | is], acc, d, fb) do
  ...
  defp replace_labels_1(
         [
           {:bs_create_bin, {:f, lbl}, alloc, live, unit, dst, {:list, list}}
           | is
         ],
         acc,
         d,
    ...
    replace_labels_1(
      is,
      [
        {:bs_create_bin, {:f, label(lbl, d, fb)}, alloc, live, unit, dst, {:list, list}}
        | acc
      ],
      d,
      fb
  ...
  defp replace_labels_1([{:bs_match, {:f, lbl}, ctx, list} | is], acc, d, fb) do
