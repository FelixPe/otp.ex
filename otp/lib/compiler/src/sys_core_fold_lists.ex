defmodule :m_sys_core_fold_lists do
  ...
  def call(r_c_call(anno: anno), :lists, :all, [arg1, arg2]) do
    ...
    cC1 = r_c_clause(anno: anno, pats: [r_c_literal(val: true)],
              guard: r_c_literal(val: true),
              body: r_c_apply(anno: anno, op: loop, args: [xs]))
    cC2 = r_c_clause(anno: anno, pats: [r_c_literal(val: false)],
              guard: r_c_literal(val: true), body: r_c_literal(val: false))
    cC3 = r_c_clause(anno: [:compiler_generated | anno], pats: [x],
              guard: r_c_literal(val: true), body: match_fail(anno, err1))
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: r_c_case(anno: anno,
                       arg: r_c_apply(anno: anno, op: f, args: [x]),
                       clauses: [cC1, cC2, cC3]))
    c2 = r_c_clause(anno: anno, pats: [r_c_literal(val: [])],
             guard: r_c_call(module: r_c_literal(val: :erlang),
                        name: r_c_literal(val: :is_function), args: [f, r_c_literal(val: 1)]),
             body: r_c_literal(val: true))
    c3 = r_c_clause(anno: anno, pats: [xs], guard: r_c_literal(val: true),
             body: function_clause(anno, [f, xs]))
    fun = r_c_fun(vars: [xs],
              body: r_c_case(anno: anno, arg: xs, clauses: [c1, c2, c3]))
    l = r_c_var(name: :L)
    r_c_let(vars: [f, l], arg: r_c_values(es: [arg1, arg2]),
        body: r_c_letrec(defs: [{loop, fun}],
  ...
  def call(r_c_call(anno: anno), :lists, :any, [arg1, arg2]) do
    ...
    err1 = r_c_tuple(es: [r_c_literal(val: :case_clause), x])
    cC1 = r_c_clause(anno: anno, pats: [r_c_literal(val: true)],
              guard: r_c_literal(val: true), body: r_c_literal(val: true))
    cC2 = r_c_clause(anno: anno, pats: [r_c_literal(val: false)],
              guard: r_c_literal(val: true),
              body: r_c_apply(anno: anno, op: loop, args: [xs]))
    cC3 = r_c_clause(anno: [:compiler_generated | anno], pats: [x],
    ...
    c3 = r_c_clause(pats: [xs], guard: r_c_literal(val: true),
             body: function_clause(anno, [f, xs]))
    fun = r_c_fun(vars: [xs],
              body: r_c_case(anno: anno, arg: xs, clauses: [c1, c2, c3]))
    l = r_c_var(name: :L)
  ...
  def call(r_c_call(anno: anno), :lists, :foreach, [arg1, arg2]) do
    ...
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: r_c_seq(arg: r_c_apply(anno: anno, op: f, args: [x]),
                       body: r_c_apply(anno: anno, op: loop, args: [xs])))
    c2 = r_c_clause(anno: anno, pats: [r_c_literal(val: [])],
             guard: r_c_call(module: r_c_literal(val: :erlang),
                        name: r_c_literal(val: :is_function), args: [f, r_c_literal(val: 1)]),
  ...
  def call(r_c_call(anno: anno), :lists, :map, [arg1, arg2]) do
    ...
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: r_c_let(vars: [h], arg: r_c_apply(anno: anno, op: f, args: [x]),
                       body: r_c_cons(hd: h, anno: [:compiler_generated],
  ...
  def call(r_c_call(anno: anno), :lists, :flatmap, [arg1, arg2]) do
    ...
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: r_c_let(vars: [h], arg: r_c_apply(anno: anno, op: f, args: [x]),
                       body: r_c_call(anno: [:compiler_generated | anno],
                                 module: r_c_literal(val: :erlang), name: r_c_literal(val: :"++"),
                                 args: [h, r_c_apply(anno: anno, op: loop,
                                               args: [xs])])))
    c2 = r_c_clause(anno: anno, pats: [r_c_literal(val: [])],
             guard: r_c_call(module: r_c_literal(val: :erlang),
                        name: r_c_literal(val: :is_function), args: [f, r_c_literal(val: 1)]),
  ...
  def call(r_c_call(anno: anno), :lists, :filter, [arg1, arg2]) do
    ...
    cC2 = r_c_clause(anno: anno, pats: [r_c_literal(val: false)],
              guard: r_c_literal(val: true), body: xs)
    cC3 = r_c_clause(anno: anno, pats: [x], guard: r_c_literal(val: true),
              body: match_fail(anno, err1))
    case__ = r_c_case(arg: b, clauses: [cC1, cC2, cC3])
    c1 = r_c_clause(pats: [r_c_cons(hd: x, tl: xs)], guard: r_c_literal(val: true),
             body: r_c_let(vars: [b], arg: r_c_apply(anno: anno, op: f, args: [x]),
                       body: r_c_let(vars: [xs],
  ...
  def call(r_c_call(anno: anno), :lists, :foldl,
           [arg1, arg2, arg3]) do
    ...
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: r_c_apply(anno: anno, op: loop,
                       args: [xs, r_c_apply(anno: anno, op: f, args: [x, a])]))
    c2 = r_c_clause(anno: anno, pats: [r_c_literal(val: [])],
             guard: r_c_call(module: r_c_literal(val: :erlang),
                        name: r_c_literal(val: :is_function), args: [f, r_c_literal(val: 2)]),
             body: a)
    c3 = r_c_clause(anno: anno, pats: [xs], guard: r_c_literal(val: true),
             body: function_clause(anno, [f, a, xs]))
    fun = r_c_fun(vars: [xs, a],
              body: r_c_case(arg: xs, clauses: [c1, c2, c3]))
    l = r_c_var(name: :L)
    r_c_let(vars: [f, a, l], arg: r_c_values(es: [arg1, arg2, arg3]),
        body: r_c_letrec(defs: [{loop, fun}],
                  body: r_c_apply(anno: anno, op: loop, args: [l, a])))
  end

  def call(r_c_call(anno: anno), :lists, :foldr,
           [arg1, arg2, arg3]) do
    ...
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: r_c_apply(anno: anno, op: f,
                       args: [x, r_c_apply(anno: anno, op: loop, args: [xs, a])]))
    c2 = r_c_clause(anno: anno, pats: [r_c_literal(val: [])],
             guard: r_c_call(module: r_c_literal(val: :erlang),
                        name: r_c_literal(val: :is_function), args: [f, r_c_literal(val: 2)]),
             body: a)
  ...
  def call(r_c_call(anno: anno), :lists, :mapfoldl,
           [arg1, arg2, arg3]) do
    ...
    avar = r_c_var(name: :A)
    match = fn a, p, e ->
                 c1 = r_c_clause(anno: anno, pats: [p], guard: r_c_literal(val: true),
                          body: e)
                 err = r_c_tuple(es: [r_c_literal(val: :badmatch), x])
                 c2 = r_c_clause(anno: anno, pats: [x], guard: r_c_literal(val: true),
                          body: match_fail(anno, err))
                 r_c_case(arg: a, clauses: [c1, c2])
            end
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: match.(r_c_apply(anno: anno, op: f, args: [x, avar]),
                            r_c_tuple(es: [x, avar]),
                            match.(r_c_apply(anno: anno, op: loop, args: [xs, avar]),
                                     r_c_tuple(es: [xs, avar]),
                                     r_c_tuple(anno: [:compiler_generated],
                                         es: [r_c_cons(anno: [:compiler_generated],
                                                  hd: x, tl: xs),
                                                  avar]))))
    c2 = r_c_clause(anno: anno, pats: [r_c_literal(val: [])],
             guard: r_c_call(module: r_c_literal(val: :erlang),
                        name: r_c_literal(val: :is_function), args: [f, r_c_literal(val: 2)]),
             body: r_c_tuple(anno: [:compiler_generated],
                       es: [r_c_literal(val: []), avar]))
    c3 = r_c_clause(anno: anno, pats: [xs], guard: r_c_literal(val: true),
             body: function_clause(anno, [f, avar, xs]))
    fun = r_c_fun(vars: [xs, avar],
              body: r_c_case(arg: xs, clauses: [c1, c2, c3]))
    l = r_c_var(name: :L)
    r_c_let(vars: [f, avar, l], arg: r_c_values(es: [arg1, arg2, arg3]),
        body: r_c_letrec(defs: [{loop, fun}],
                  body: r_c_apply(anno: anno, op: loop, args: [l, avar])))
  end

  def call(r_c_call(anno: anno), :lists, :mapfoldr,
           [arg1, arg2, arg3]) do
    ...
    c1 = r_c_clause(anno: anno, pats: [r_c_cons(hd: x, tl: xs)],
             guard: r_c_literal(val: true),
             body: match.(r_c_apply(anno: anno, op: loop, args: [xs, avar]),
                            r_c_tuple(es: [xs, avar]),
                            match.(r_c_apply(anno: anno, op: f, args: [x, avar]),
                                     r_c_tuple(es: [x, avar]),
                                     r_c_tuple(anno: [:compiler_generated],
                                         es: [r_c_cons(anno: [:compiler_generated],
                                                  hd: x, tl: xs),
  ...
  defp function_clause(anno, args) do
    r_c_call(anno: anno, module: r_c_literal(val: :erlang),
        ...
        args: [r_c_literal(val: :function_clause),
                   :cerl.ann_make_list(anno, args)])
  end
