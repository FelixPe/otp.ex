defmodule :m_v3_core do
  use Bitwise
  import :cerl, only: [ann_c_cons: 3, ann_c_map: 3,
                         ann_c_tuple: 2, c_tuple: 1, cons_hd: 1, cons_tl: 1]
  import :lists, only: [any: 2, droplast: 1, duplicate: 2,
                          foldl: 3, foldr: 3, keydelete: 3, keyfind: 3,
                          keymember: 3, last: 1, map: 2, mapfoldl: 3, member: 2,
                          reverse: 1, reverse: 2, sort: 1, splitwith: 2]
  import :ordsets, only: [add_element: 2, del_element: 2,
                            intersection: 2, is_element: 2, subtract: 2,
                            union: 1, union: 2]
  require Record
  ...
  Record.defrecord(:r_iapply, :iapply, anno: :EFE_TODO_NESTED_RECORD,
                                  op: :undefined, args: :undefined)
  Record.defrecord(:r_ibinary, :ibinary, anno: :EFE_TODO_NESTED_RECORD,
                                   segments: :undefined)
  Record.defrecord(:r_ibitstr, :ibitstr, anno: :EFE_TODO_NESTED_RECORD,
                                   val: :undefined, size: :undefined,
                                   unit: :undefined, type: :undefined,
                                   flags: :undefined)
  Record.defrecord(:r_icall, :icall, anno: :EFE_TODO_NESTED_RECORD,
                                 module: :undefined, name: :undefined,
                                 args: :undefined)
  Record.defrecord(:r_icase, :icase, anno: :EFE_TODO_NESTED_RECORD,
                                 args: :undefined, clauses: :undefined,
                                 fc: :undefined)
  Record.defrecord(:r_icatch, :icatch, anno: :EFE_TODO_NESTED_RECORD,
                                  body: :undefined)
  Record.defrecord(:r_iclause, :iclause, anno: :EFE_TODO_NESTED_RECORD,
                                   pats: :undefined, guard: :undefined,
                                   body: :undefined)
  Record.defrecord(:r_ifun, :ifun, anno: :EFE_TODO_NESTED_RECORD,
                                id: :undefined, vars: :undefined,
                                clauses: :undefined, fc: :undefined,
                                name: :unnamed)
  Record.defrecord(:r_iletrec, :iletrec, anno: :EFE_TODO_NESTED_RECORD,
                                   defs: :undefined, body: :undefined)
  Record.defrecord(:r_imatch, :imatch, anno: :EFE_TODO_NESTED_RECORD,
                                  pat: :undefined, guard: [], arg: :undefined,
                                  fc: :undefined)
  Record.defrecord(:r_iexprs, :iexprs, anno: :EFE_TODO_NESTED_RECORD,
                                  bodies: [])
  Record.defrecord(:r_imap, :imap, anno: :EFE_TODO_NESTED_RECORD,
                                arg: :EFE_TODO_NESTED_RECORD, es: :undefined,
                                is_pat: false)
  Record.defrecord(:r_imappair, :imappair, anno: :EFE_TODO_NESTED_RECORD,
                                    op: :undefined, key: :undefined,
                                    val: :undefined)
  Record.defrecord(:r_iprimop, :iprimop, anno: :EFE_TODO_NESTED_RECORD,
                                   name: :undefined, args: :undefined)
  Record.defrecord(:r_iprotect, :iprotect, anno: :EFE_TODO_NESTED_RECORD,
                                    body: :undefined)
  Record.defrecord(:r_ireceive1, :ireceive1, anno: :EFE_TODO_NESTED_RECORD,
                                     clauses: :undefined)
  Record.defrecord(:r_ireceive2, :ireceive2, anno: :EFE_TODO_NESTED_RECORD,
                                     clauses: :undefined, timeout: :undefined,
                                     action: :undefined)
  Record.defrecord(:r_iset, :iset, anno: :EFE_TODO_NESTED_RECORD,
                                var: :undefined, arg: :undefined)
  Record.defrecord(:r_itry, :itry, anno: :EFE_TODO_NESTED_RECORD,
                                args: :undefined, vars: :undefined,
                                body: :undefined, evars: :undefined,
                                handler: :undefined)
  Record.defrecord(:r_ifilter, :ifilter, anno: :EFE_TODO_NESTED_RECORD,
                                   arg: :undefined)
  Record.defrecord(:r_igen, :igen, anno: :EFE_TODO_NESTED_RECORD,
                                acc_pat: :undefined, acc_guard: :undefined,
                                skip_pat: :undefined, tail: :undefined,
                                tail_pat: :undefined, arg: :undefined,
                                refill: {:nomatch, :ignore})
  Record.defrecord(:r_isimple, :isimple, anno: :EFE_TODO_NESTED_RECORD,
                                   term: :undefined)
  Record.defrecord(:r_core, :core, vcount: 0, fcount: 0,
                                gcount: 0, function: {:none, 0},
                                in_guard: false, wanted: true, opts: [],
                                dialyzer: false, ws: [], file: [{:file, ''}],
                                load_nif: false)
  Record.defrecord(:r_imodule, :imodule, name: [],
                                   exports: :ordsets.new(), nifs: :none,
                                   attrs: [], defs: [], file: [], opts: [],
                                   ws: [], load_nif: false)
  def module(forms0, opts) do
    forms = :erl_internal.add_predefined_functions(forms0)
    module = foldl(fn f, acc ->
                        form(f, acc, opts)
                   end,
                     r_imodule(), forms)
    r_imodule(name: mod, exports: exp0, attrs: as0, defs: kfs0,
        ws: ws, load_nif: loadNif, nifs: nifs) = module
    exp = (case (member(:export_all, opts)) do
             true ->
               defined_functions(forms)
             false ->
               exp0
           end)
    cexp = (for ({_, _} = fA) <- exp do
              r_c_var(name: fA)
            end)
    kfs1 = reverse(kfs0)
    kfs = (cond do
    ...
    as = reverse(as0)
    {:ok,
       r_c_module(name: r_c_literal(val: mod), exports: cexp, attrs: as,
           defs: kfs),
       ws}
  end

  defp form({:function, _, _, _, _} = f0,
            r_imodule(defs: defs, load_nif: loadNif0) = module, opts) do
    {f, ws, loadNif} = function(f0, module, opts)
    r_imodule(module, defs: [f | defs],  ws: ws, 
                load_nif: :erlang.or(loadNif, loadNif0))
  end
  ...
  defp form({:attribute, _, :file, {file, _Line}} = f,
            r_imodule(attrs: as) = module, _Opts) do
  ...
  defp form({:attribute, _, :export, es},
            r_imodule(exports: exp0) = module, _Opts) do
    exp = :ordsets.union(:ordsets.from_list(es), exp0)
    r_imodule(module, exports: exp)
  end

  defp form({:attribute, _, :nifs, ns},
            r_imodule(nifs: nifs0) = module, _Opts) do
    nifs1 = (case (nifs0) do
               :none ->
                 :sets.new([{:version, 2}])
               _ ->
    ...
    nifs = :sets.union(:sets.from_list(ns, [{:version, 2}]),
                         nifs1)
    r_imodule(module, nifs: nifs)
  end

  defp form({:attribute, _, _, _} = f,
            r_imodule(attrs: as) = module, _Opts) do
  ...
  defp defined_functions(forms) do
    fs = (for {:function, _, name, arity, _} <- forms do
            {name, arity}
          end)
  ...
  defp function({:function, _, name, arity, cs0}, module, opts)
    ...
    try do
      st0 = r_core(vcount: 0, function: {name, arity}, opts: opts,
                dialyzer: member(:dialyzer, opts), ws: ws0,
                file: [{:file, file}])
  ...
  defp body(cs0, name, arity, st0) do
    ...
    {r_ifun(anno: r_a(anno: funAnno), id: [], vars: args,
         clauses: cs1, fc: fc),
       st3}
  end
  ...
  defp clause({:clause, lc, h0, g0, b0}, st0) do
    try do
      ...
      {h1, st1} ->
        ...
        {r_iclause(anno: r_a(anno: anno), pats: h1, guard: g1, body: b1),
           st3}
    end
  end
  ...
  defp guard(gs0, st0) do
    gs1 = foldr(fn gt0, rhs ->
                     gt1 = guard_tests(gt0)
                     l = :erlang.element(2, gt1)
                     {:op, l, :or, gt1, rhs}
                end,
                  guard_tests(last(gs0)), droplast(gs0))
  ...
  defp gexpr({:protect, line, arg}, bools0, st0) do
    case (gexpr(arg, [], st0)) do
      ...
      {e0, eps0, bools, st1} ->
        ...
        {r_iprotect(anno: r_a(anno: anno), body: eps ++ [e]), [], bools0,
           st}
    end
  end
  ...
  defp gexpr({:call, line,
             {:remote, _, {:atom, _, :erlang}, {:atom, _, op}},
             [l, r]} = e,
            bools, st) do
    case (:erl_internal.bool_op(op, 2)) do
      true ->
  ...
  defp gexpr({:call, line,
             {:remote, _, {:atom, _, :erlang}, {:atom, _, :not}},
             [a]},
            bools, st) do
    gexpr_not(a, bools, st, line)
  end
  ...
  defp gexpr_bool(op, l, r, bools0, st0, line) do
    ...
    {r_icall(anno: r_a(anno: anno),
         module: r_c_literal(anno: anno, val: :erlang),
         name: r_c_literal(anno: anno, val: op), args: [ll, rl]),
  ...
  defp gexpr_not(a, bools0, st0, line) do
    ...
    case (ae0) do
      r_icall(anno: r_a(anno: [:v3_core, :compiler_generated]),
          module: r_c_literal(val: :erlang), name: r_c_literal(val: :"=:="),
          args: [e, r_c_literal(val: true)]) = eqCall ->
      ...
      ae ->
        ...
        {r_icall(anno: r_a(anno: anno),
             module: r_c_literal(anno: anno, val: :erlang),
             name: r_c_literal(anno: anno, val: :not), args: [al]),
           aps ++ alps, bools, st2}
    end
  end

  defp gexpr_test({:atom, l, true}, bools, st0) do
    {r_c_literal(anno: lineno_anno(l, st0), val: true), [], bools,
       st0}
  end

  defp gexpr_test({:atom, l, false}, bools, st0) do
    {r_c_literal(anno: lineno_anno(l, st0), val: false), [], bools,
       st0}
  end
  ...
  defp gexpr_test(e0, bools0, st0) do
    ...
    case (e1) do
      r_icall(anno: anno, module: r_c_literal(val: :erlang),
          name: r_c_literal(val: :is_function), args: [_, _]) ->
        lanno = r_a(anno, :anno)
        {new, st2} = new_var(lanno, st1)
        {icall_eq_true(new),
           eps0 ++ [r_iset(anno: anno, var: new, arg: e1)], bools0, st2}
      r_icall(anno: anno, module: r_c_literal(val: :erlang), name: r_c_literal(val: n),
          args: as) ->
        ar = length(as)
        case (:erl_internal.new_type_test(n,
                                            ar) or :erl_internal.comp_op(n,
                                                                           ar) or :erl_internal.bool_op(n,
                                                                                                          ar)) do
          true ->
            {e1, eps0, bools0, st1}
          false ->
            ...
            bools = [new | bools0]
            {icall_eq_true(new),
               eps0 ++ [r_iset(anno: anno, var: new, arg: e1)], bools, st2}
        end
      _ ->
        ...
        case (is_simple(e1)) do
          ...
          false ->
            ...
            bools = [new | bools0]
            {icall_eq_true(new),
               eps0 ++ [r_iset(anno: aCompGen, var: new, arg: e1)], bools,
               st2}
        end
    end
  end
  ...
  defp force_booleans_1([v | vs], e0, eps0, st0) do
    ...
    aCompGen = r_a(anno: [:compiler_generated])
    call = r_icall(anno: aCompGen, module: r_c_literal(val: :erlang),
               name: r_c_literal(val: :is_boolean), args: [v])
    {new, st} = new_var([], st1)
    iset = r_iset(var: new, arg: call)
    eps = eps0 ++ eps1 ++ [iset]
    e = r_icall(anno: aCompGen, module: r_c_literal(val: :erlang),
            name: r_c_literal(val: :and), args: [e1, new])
    force_booleans_1(vs, e, eps, st)
  end
  ...
  defp unforce_tree_subst(r_icall(module: r_c_literal(val: :erlang), name: r_c_literal(val: :"=:="),
              args: [_Expr, r_c_literal(val: bool)]) = call,
            _)
  ...
  defp unforce_tree_subst(r_icall(args: args0) = call, d) do
    args = map(fn r_c_var(name: v) = var ->
  ...
  defp unforce(r_icall(module: r_c_literal(val: :erlang), name: r_c_literal(val: name),
              args: args),
            vs0) do
    case ({name, args}) do
      {:and, [arg1, arg2]} ->
  ...
  defp maybe_match_exprs([{:maybe_match, l, p0, e0} | es0], fail, st0) do
    ...
    {c, st2} = (case (es1) do
                  [] ->
                    ...
                    all = {:var, l, allName}
                    clause({:clause, l, [{:match, l, p0, all}], [], [all]},
                             stInt)
                  [_ | _] ->
                    {c0, stInt} = clause({:clause, l, [p0], [], [{nil, 0}]},
                                           st1)
    ...
    fc = r_iclause(anno: r_a(anno: [:dialyzer_ignore,
                              :compiler_generated | lanno]),
             pats: [fpat], guard: [],
             body: [r_iapply(op: fail, args: [fpat])])
    {eps ++ [r_icase(anno: r_a(anno: lanno), args: [e1],
                 clauses: [c], fc: fc)],
       st4}
  end
  ...
  defp expr({:lc, l, e, qs0}, st0) do
    ...
    lc_tq(l, e, qs1, r_c_literal(anno: lineno_anno(l, st1), val: []),
            st1)
  end
  ...
  defp expr({:mc, l, e, qs0}, st0) do
    {qs1, st1} = preprocess_quals(l, qs0, st0)
    mc_tq(l, e, qs1, r_c_literal(anno: lineno_anno(l, st1), val: []),
            st1)
  end
  ...
  defp expr({:map, l, es0}, st0) do
    map_build_pairs(r_c_literal(val: %{}), es0, full_anno(l, st0),
                      st0)
  end
  ...
  defp expr({:bin, l, es0}, st0) do
    try do
      ...
      {:bad_binary, eps, st1} ->
        ...
        {r_icall(anno: r_a(anno: lineAnno),
             module: r_c_literal(anno: lineAnno, val: :erlang),
             name: r_c_literal(anno: lineAnno, val: :error), args: as),
           eps, st}
    else
      {_, _, _} = res ->
        res
  ...
  defp expr({:maybe, l, es0, {:else, _, cs0}}, st0) do
    ...
    fc1 = fail_clause([failVar], lanno,
                        c_tuple([r_c_literal(val: :else_clause), failVar]))
    failCase = r_icase(args: [v2], clauses: cs1, fc: fc1)
    failFunCs = [r_iclause(pats: [v2], guard: [r_c_literal(val: true)],
                     body: [failCase])]
    anno = r_a(anno: [:letrec_goto, :no_inline | lanno])
    fc2 = fail_clause([failVar], lanno,
                        r_c_literal(val: :never_fails))
    failFun = r_ifun(id: [], vars: [v1], clauses: failFunCs,
                  fc: fc2)
    letrec = r_iletrec(anno: anno, defs: [{fail, failFun}],
                 body: es1)
    {letrec, [], st3}
  end
  ...
  defp expr({:if, l, cs0}, st0) do
    ...
    {r_icase(anno: r_a(anno: lanno), args: [], clauses: cs1,
         fc: fc),
       [], st1}
  end
  ...
  defp expr({:case, l, e0, cs0}, st0) do
    ...
    fc = fail_clause([fpat], lanno,
                       c_tuple([r_c_literal(val: :case_clause), fpat]))
    {r_icase(anno: r_a(anno: lanno), args: [e1], clauses: cs1,
         fc: fc),
       eps, st3}
  end
  ...
  defp expr({:receive, l, cs0}, st0) do
    {cs1, st1} = clauses(cs0, st0)
    {r_ireceive1(anno: r_a(anno: lineno_anno(l, st1)), clauses: cs1),
       [], st1}
  end
  ...
  defp expr({:receive, l, cs0, te0, tes0}, st0) do
    ...
    {cs1, st3} = clauses(cs0, st2)
    {r_ireceive2(anno: r_a(anno: lineno_anno(l, st3)), clauses: cs1,
         timeout: te1, action: tes1),
       teps, st3}
  end
  ...
  defp expr({:try, l, es0, [], ecs, []}, st0) do
    ...
    {r_itry(anno: r_a(anno: lanno), args: es1, vars: [v],
         body: [v], evars: evs, handler: hs),
       [], st3}
  end
  ...
  defp expr({:try, l, es0, cs0, ecs, []}, st0) do
    ...
    lanno = lineno_anno(l, st4)
    fc = fail_clause([fpat], lanno,
                       c_tuple([r_c_literal(val: :try_clause), fpat]))
    {evs, hs, st5} = try_exception(ecs, st4)
    {r_itry(anno: r_a(anno: lineno_anno(l, st5)), args: es1,
         vars: [v],
         body: [r_icase(anno: r_a(anno: lanno), args: [v], clauses: cs1,
                    fc: fc)],
  ...
  defp expr({:fun, l, {:function, m, f, a}}, st0) do
    ...
    lanno = full_anno(l, st1)
    {r_icall(anno: r_a(anno: lanno), module: r_c_literal(val: :erlang),
         name: r_c_literal(val: :make_fun), args: as),
       aps, st1}
  end
  ...
  defp expr({:call, l, {:remote, _, m0, f0}, as0}, st0) do
    {[m1, f1 | as1], aps, st1} = safe_list([m0, f0 | as0],
                                             st0)
    anno = full_anno(l, st1)
    case ({m1, f1, as1}) do
      {r_c_literal(val: :erlang), r_c_literal(val: :error),
         [r_c_tuple(es: [r_c_literal(val: :badrecord), _]) = tuple]} ->
        fail = r_iprimop(anno: r_a(anno: anno), name: r_c_literal(val: :match_fail),
                   args: [tuple])
        {fail, aps, st1}
      {r_c_literal(val: :erlang), r_c_literal(val: :load_nif), [_, _]} ->
        {r_icall(anno: r_a(anno: anno), module: m1, name: f1,
             args: as1),
           aps, r_core(st1, load_nif: true)}
      {_, _, _} ->
        {r_icall(anno: r_a(anno: anno), module: m1, name: f1,
             args: as1),
           aps, st1}
  ...
  defp expr({:call, lc, {:atom, lf, f}, as0}, st0) do
    ...
    op = r_c_var(anno: lineno_anno(lf, st1),
             name: {f, length(as1)})
    {r_iapply(anno: r_a(anno: lineno_anno(lc, st1)), op: op,
         args: as1),
       aps, st1}
  end
  ...
  defp expr({:call, l, funExp, as0}, st0) do
    ...
    lanno = lineno_anno(l, st2)
    {r_iapply(anno: r_a(anno: lanno), op: fun, args: as1),
       fps ++ aps, st2}
  end
  ...
  defp expr({:op, l, op, a0}, st0) do
    ...
    {r_icall(anno: r_a(anno: lineAnno),
         module: r_c_literal(anno: lineAnno, val: :erlang),
         name: r_c_literal(anno: lineAnno, val: op), args: [a1]),
       aps, st1}
  end
  ...
  defp expr({:op, l, op, l0, r0}, st0) do
    ...
    {r_icall(anno: r_a(anno: lineAnno),
         module: r_c_literal(anno: lineAnno, val: :erlang),
         name: r_c_literal(anno: lineAnno, val: op), args: as),
       aps, st1}
  end

  defp expr({:ssa_check_when, l, wantedResult, args, tag,
             clauses},
            st) do
    {r_c_opaque(anno: full_anno(l, st),
         val: {:ssa_check_when, wantedResult, tag, args,
                 clauses}),
       [], st}
  end
  ...
  defp single_match(l, p0, e, st0) do
    ...
    lanno = lineno_anno(l, st1)
    fc = fail_clause([fpat], lanno,
                       c_tuple([r_c_literal(val: :badmatch), fpat]))
    try do
      pattern(p0, st1)
    catch
      :nomatch ->
        ...
        fail = r_iprimop(anno: r_a(anno: lanno),
                   name: r_c_literal(val: :match_fail), args: [badmatch])
        eps = eps0 ++ [fail]
        {r_imatch(anno: r_a(anno: lanno), pat: sanPat, arg: expr,
             fc: fc),
           eps, st}
    else
      {p1, st2} ->
        ...
        {r_imatch(anno: r_a(anno: lanno), pat: p1, arg: e, fc: fc), [],
           st4}
    end
  end
  ...
  defp sanitize({:bin, l, segs0}) do
    segs = (for {:bin_element, _, {:var, _, _} = var, _,
                   _} <- segs0 do
              var
            end)
    {:tuple, l, segs}
  ...
  defp sanitize({:map, l, ps0}) do
    ps = (for {:map_field_exact, _, _, v} <- ps0 do
            sanitize(v)
          end)
    {:tuple, l, ps}
  end
  ...
  defp expr_map(m0, es0, l, st0) do
    ...
    a = lineno_anno(l, st1)
    fc = fail_clause([], [{:eval_failure, :badmap} | a],
                       badmap)
    {m2, eps1, st2} = map_build_pairs(m1, es0,
                                        full_anno(l, st1), st1)
    m3 = (case (es0) do
            [] ->
              m1
    ...
    cs = [r_iclause(anno: r_a(anno: [:compiler_generated | a]),
              pats: [],
              guard: [r_icall(anno: r_a(anno: a),
                          module: r_c_literal(anno: a, val: :erlang),
                          name: r_c_literal(anno: a, val: :is_map), args: [m1])],
              body: [m3])]
    eps = eps0 ++ eps1
    {r_icase(anno: r_a(anno: a), args: [], clauses: cs, fc: fc),
       eps, st2}
  end
  ...
  defp map_build_pairs(map, es0, ann, st0) do
    {es, pre, _, st1} = map_build_pairs_1(es0,
                                            :sets.new([{:version, 2}]), st0)
  ...
  defp map_build_pairs_1([{op0, l, k0, v0} | es], used0, st0) do
    ...
    {pairs, pre2, used1, st3} = map_build_pairs_1(es, used0,
                                                    st2)
    as = lineno_anno(l, st3)
    op = map_op(op0)
    {used2, st4} = maybe_warn_repeated_keys(k, k0, used1,
                                              st3)
  ...
  defp try_exception(ecs0, st0) do
    ...
    ec = r_iclause(anno: r_a(anno: [:compiler_generated | lA]),
             pats: [c_tuple(evs)], guard: [r_c_literal(val: true)],
             body: [r_iprimop(anno: r_a(), name: r_c_literal(val: :raise),
                        args: [info, value])])
    hs = [r_icase(anno: r_a(anno: lA), args: [c_tuple(evs)],
              clauses: ecs2, fc: ec)]
    {evs, hs, st2}
  end
  ...
  defp try_after_large(lA, es, as, v, st0) do
    ...
    fun = r_ifun(anno: lanno, id: [], vars: [],
              clauses: [r_iclause(anno: lanno, pats: [],
                            guard: [r_c_literal(val: true)], body: as)],
              fc: fc)
    app = r_iapply(anno: r_a(anno: [:compiler_generated | lA]),
              op: r_c_var(anno: lA, name: {name, 0}), args: [])
    {evs, hs, st} = after_block([app], st1)
    try = r_itry(anno: lanno, args: es, vars: [v],
              body: [app, v], evars: evs, handler: hs)
    letrec = r_iletrec(anno: lanno, defs: [{{name, 0}, fun}],
                 body: [try])
    {letrec, [], st}
  end
  ...
  defp try_after_small(lA, es, as, v, st0) do
    ...
    try = r_itry(anno: lanno, args: es, vars: [v],
              body: as ++ [v], evars: evs, handler: hs)
    {try, [], st1}
  end
  ...
  defp after_block(as, st0) do
    {evs, st1} = new_vars(3, st0)
    [_, value, info] = evs
    b = as ++ [r_iprimop(anno: r_a(), name: r_c_literal(val: :raise),
                   args: [info, value])]
    ec = r_iclause(anno: r_a(anno: [:compiler_generated]),
             pats: [c_tuple(evs)], guard: [r_c_literal(val: true)], body: b)
    hs = [r_icase(anno: r_a(), args: [c_tuple(evs)], clauses: [],
              fc: ec)]
    {evs, hs, st1}
  end
  ...
  defp try_build_stacktrace([r_iclause(pats: ps0, body: b0) = c0 | cs], rawStk) do
    ...
    case (stk) do
      ...
      _ ->
        ...
        call = r_iprimop(anno: r_a(), name: r_c_literal(val: :build_stacktrace),
                   args: [rawStk])
  ...
  defp bitstr({:bin_element, {:sl, _, line}, {:string, _, s},
             {:integer, _, 8}, _},
            st) do
    bitstrs(bin_expand_string(s, {:sl, 0, line}, 0, 0, []),
              st)
  end

  defp bitstr({:bin_element, {:sl, _, line}, {:string, _, []},
             sz0, ts},
            st0) do
    {[r_c_bitstr(size: sz)], eps0, st1} = bitstr({:bin_element,
                                           {:sl, 0, line}, {:char, line, 0},
                                           sz0, ts},
                                          st0)
    case (sz) do
      ...
      r_c_var() ->
        ...
        test0 = {:call, line,
                   {:remote, line, erlang, {:atom, line, :is_integer}},
                   [sz0]}
        test1 = {:call, line,
                   {:remote, line, erlang, {:atom, line, :">="}},
                   [sz0, {:integer, line, 0}]}
        test2 = {:op, line, :andalso, test0, test1}
        fail = {:call, line,
                  {:remote, line, erlang, {:atom, line, :error}},
                  [{:atom, line, :badarg}]}
  ...
  defp bitstr({:bin_element, {:sl, _, line}, {:string, _, s},
             sz0, ts},
            st0) do
    {[bitstr], eps, st1} = bitstr({:bin_element,
                                     {:sl, 0, line}, {:char, line, 0}, sz0, ts},
                                    st0)
    es = (for c <- s do
  ...
  defp bitstr({:bin_element, {:sl, seg, line}, e0, size0,
             [type, {:unit, unit} | flags]},
            st0) do
    ...
    {[r_c_bitstr(anno: anno, val: e1, size: size1,
          unit: r_c_literal(val: unit), type: r_c_literal(val: type),
          flags: r_c_literal(val: flags))],
       eps, st2}
  end

  defp bin_elements([{:bin_element, line, expr, size0, type0} | es],
            seg) do
  ...
  defp make_bit_type(_Line, {:atom, anno, :all} = size, type0,
            context) do
  ...
  defp fun_tq(cs0, l, st0, nameInfo) do
    ...
    id = {0, 0, name}
    fun = r_ifun(anno: r_a(anno: anno), id: [{:id, id}],
              vars: args, clauses: cs1, fc: fc, name: nameInfo)
    {fun, [], st4}
  end

  defp lc_tq(line, e,
            [r_igen(anno: r_a(anno: gA) = gAnno, acc_pat: accPat,
                 acc_guard: accGuard, skip_pat: skipPat, tail: tail,
                 tail_pat: tailPat, refill: {refillPat, refillAction},
                 arg: {pre, arg}) |
                 qs],
            mc, st0) do
    ...
    skipClause = make_clause([:skip_clause,
                                  :compiler_generated | lA],
                               skipPat, [], [], [nc])
    tailClause = make_clause(lA, tailPat, [], [], [mc])
    {lc, lps, st3} = lc_tq(line, e, qs, nc, st2)
    accClause = make_clause(lA, accPat, [], accGuard,
                              lps ++ [lc])
    refillClause = make_clause(lA, refillPat, [], [],
                                 [refillAction, nc])
    cs0 = [accClause, skipClause, tailClause, refillClause]
    cs = (for c <- cs0, c !== :nomatch do
            c
          end)
    fun = r_ifun(anno: gAnno, id: [], vars: [var], clauses: cs,
              fc: fc)
    {r_iletrec(anno: r_a(gAnno, anno: [:list_comprehension | gA]),
         defs: [{{name, 1}, fun}],
  ...
  defp lc_tq(line, e0, [], mc0, st0) do
    ...
    {set_anno(e, [:compiler_generated | anno]), hps ++ tps,
       st}
  end
  ...
  defp bc_tq(line, exp, qs0, st0) do
    ...
    pre = prePre ++ [r_iset(var: binVar,
                         arg: r_iprimop(anno: r_a(anno: lineno_anno(line, st)),
  ...
  defp bc_tq1(line, e,
            [r_igen(anno: gAnno, acc_pat: accPat, acc_guard: accGuard,
                 skip_pat: skipPat, tail: tail, tail_pat: tailPat,
                 refill: {refillPat, refillAction}, arg: {pre, arg}) |
                 qs],
            mc, st0) do
    ...
    skipClause = make_clause([:compiler_generated,
                                  :skip_clause | lA],
                               skipPat, [ignoreVar], [], [nc])
    tailClause = make_clause(lA, tailPat, [ignoreVar], [],
                               [accVar])
    {bc, bps, st5} = bc_tq1(line, e, qs, accVar, st4)
    body = bps ++ [r_iset(var: accVar, arg: bc), nc]
    accClause = make_clause(lA, accPat, [ignoreVar],
                              accGuard, body)
    refillClause = make_clause(lA, refillPat, [accVar], [],
                                 [refillAction, nc])
    cs0 = [accClause, skipClause, tailClause, refillClause]
    cs = (for c <- cs0, c !== :nomatch do
            c
          end)
    fun = r_ifun(anno: gAnno, id: [], vars: vars, clauses: cs,
              fc: fc)
    {r_iletrec(anno: r_a(lAnno, anno: [:list_comprehension,
                                 :no_inline | lA]),
         defs: [{{name, 2}, fun}],
  ...
  defp bc_tq1(line, e0, [], accVar, st0) do
    ...
    case (e1) do
      ...
      r_c_literal(val: val) when is_bitstring(val) ->
        ...
        els = [{:bin_element, line, int, sz,
                  [:integer, {:unit, 1}, :big]}]
        bc_tq_build(line, pre0, accVar, els, st1)
      _ ->
        els = [{:bin_element, line, {:atom, line, :bad_value},
                  bsSize, bsFlags}]
        bc_tq_build(line, pre0, accVar, els, st1)
    end
  end
  ...
  defp bc_tq_build(line, pre0, r_c_var(name: accVar), elements0, st0) do
    elements = [{:bin_element, line, {:var, line, accVar},
                   make_all_size(line), [:binary, {:unit, 1}]} |
                    elements0]
    {e, pre, st} = expr({:bin, line, elements}, st0)
    r_a(anno: a) = (anno0 = get_anno(e))
    anno = r_a(anno0, anno: [:compiler_generated,
                               :single_use | a])
    {set_anno(e, anno), pre0 ++ pre, st}
  end

  defp mc_tq(line, {:map_field_assoc, lf, k, v}, qs, mc,
            st0) do
    e = {:tuple, lf, [k, v]}
    {lc, pre0, st1} = lc_tq(line, e, qs, mc, st0)
    {lcVar, st2} = new_var(st1)
    pre = pre0 ++ [r_iset(var: lcVar, arg: lc)]
    call = r_icall(module: r_c_literal(val: :maps),
               name: r_c_literal(val: :from_list), args: [lcVar])
    {call, pre, st2}
  end
  ...
  defp make_clause(anno, pat, patExtra, guard, body) do
    r_iclause(anno: r_a(anno: anno), pats: [pat | patExtra],
        guard: guard, body: body)
  end

  defp filter_tq(line, e,
            r_ifilter(anno: r_a(anno: lA) = lAnno, arg: {pre, arg}), mc, st0,
            qs, tqFun) do
    {lc, lps, st1} = tqFun.(line, e, qs, mc, st0)
    {failPat, st2} = new_var(st1)
    fc = fail_clause([failPat], lA,
                       c_tuple([r_c_literal(val: :bad_filter), failPat]))
    {r_icase(anno: r_a(lAnno, anno: [:list_comprehension | lA]),
         args: [arg],
         clauses: [r_iclause(anno: lAnno, pats: [r_c_literal(val: true)],
                       guard: [], body: lps ++ [lc]),
                       r_iclause(anno: r_a(lAnno, anno: [:compiler_generated | lA]),
                           pats: [r_c_literal(val: false)], guard: [], body: [mc])],
         fc: fc),
       pre, st2}
  end

  defp filter_tq(line, e,
            r_ifilter(anno: r_a(anno: lA) = lAnno, arg: guard), mc, st0, qs,
            tqFun)
      when is_list(guard) do
    {lc, lps, st1} = tqFun.(line, e, qs, mc, st0)
    {r_icase(anno: r_a(lAnno, anno: [:list_comprehension | lA]),
         args: [],
         clauses: [r_iclause(anno: lAnno, pats: [], guard: guard,
                       body: lps ++ [lc])],
         fc: r_iclause(anno: r_a(lAnno, anno: [:compiler_generated | lA]),
                 pats: [], guard: [], body: [mc])),
       [], st1}
  end
  ...
  defp generator(line, {:generate, lg, p0, e}, gs, st0) do
    ...
    gen = r_igen(anno: r_a(anno: gA), acc_pat: accPat,
              acc_guard: cg, skip_pat: skipPat, tail: tail,
              tail_pat: r_c_literal(anno: lA, val: []), arg: {pre, ce})
    {gen, st4}
  end
  ...
  defp generator(line, {:b_generate, lg, p, e}, gs, st0) do
    ...
    try do
      ...
      :nomatch ->
        ...
        gen = r_igen(anno: r_a(anno: gA), acc_pat: :nomatch,
                  acc_guard: [], skip_pat: :nomatch,
                  tail_pat: r_c_var(name: :_), arg: {pre, ce})
        {gen, st1}
    else
      {r_ibinary(segments: segs) = cp, st1} ->
        {accSegs, tail, tailSeg,
           st2} = append_tail_segment(segs, st1)
  ...
  defp generator(line,
            {:m_generate, lg, {:map_field_exact, _, k0, v0}, e}, gs,
            st0) do
    lA = lineno_anno(line, st0)
    gA = lineno_anno(lg, st0)
    {pat, st1} = list_gen_pattern({:cons, lg, k0, v0}, line,
                                    st0)
    {[skipK, skipV, iterVar, outerIterVar, _BadGenVar],
       st2} = new_vars(5, st1)
    {cg, st3} = lc_guard_tests(gs, st2)
    ...
    refill = {skipK,
                r_iset(var: iterVar,
                    arg: r_icall(anno: r_a(anno: gA),
                             module: r_c_literal(val: :erts_internal),
                             name: r_c_literal(val: :mc_refill), args: [skipK]))}
    initIter = r_icall(anno: r_a(anno: gA),
                   module: r_c_literal(val: :erts_internal),
                   name: r_c_literal(val: :mc_iterator), args: [ce])
    badGenerator = bad_generator([r_c_literal(val: [])], ce,
                                   r_c_literal(val: [], anno: gA))
    beforeFc = r_iclause(anno: r_a(anno: gA), pats: [iterVar],
                   guard: [], body: [iterVar])
    before = r_iset(var: outerIterVar,
                 arg: r_icase(args: [initIter], clauses: [badGenerator],
                          fc: beforeFc))
    pre = pre0 ++ [before]
    gen = r_igen(anno: r_a(anno: gA), acc_pat: accPat,
              acc_guard: cg, skip_pat: skipPat, tail: iterVar,
              tail_pat: r_c_literal(anno: lA, val: :none), refill: refill,
  ...
  defp append_tail_segment(segs, st0) do
    {var, st} = new_var(st0)
    tail = r_ibitstr(val: var, size: [r_c_literal(val: :all)],
               unit: r_c_literal(val: 1), type: r_c_literal(val: :binary),
  ...
  defp safe_list(es, st0) do
    {vs, eps0, st} = foldr(fn e, {ces, eps, sti0} ->
  ...
  defp force_safe(r_imatch(pat: p, arg: e) = imatch, st0) do
    ...
    case (le) do
      ...
      _ ->
        {v, st2} = new_var(st1)
        {v,
           lps0 ++ [r_imatch(imatch, pat: r_c_alias(var: v, pat: p),  arg: le)],
           st2}
    end
  end
  ...
  defp pattern({:bin, l, ps}, st0) do
    ...
    {r_ibinary(anno: r_a(anno: lineno_anno(l, st)),
         segments: segments),
       st}
  end
  ...
  defp pattern_map_pairs(ps, st0) do
    {cMapPairs, st1} = mapfoldl(&pattern_map_pair/2, st0,
                                  ps)
  ...
  defp pattern_map_pair({:map_field_exact, l, k, v}, st0) do
    ...
    {r_imappair(anno: r_a(anno: lineno_anno(l, st2)),
         op: r_c_literal(val: :exact), key: ck, val: cv),
       st2}
  end

  defp pat_alias_map_pairs(ps) do
    d0 = foldl(fn r_imappair(key: k0) = pair, a ->
                    k = map_sort_key(k0, a)
                    case (a) do
                      %{^k => aliases} ->
                        %{a | k => [pair | aliases]}
  ...
  defp pat_alias_map_pairs_1([{_, [r_imappair(val: v0) = pair | vs]} | t]) do
    v = foldl(fn r_imappair(val: v), pat ->
                   pat_alias(v, pat)
              end,
                v0, vs)
  ...
  defp pat_bin_expand_strings(es0, r_core(dialyzer: dialyzer)) do
    foldr(fn {:bin_element, line, {:string, _, [_ | _] = s},
                :default, :default},
               es1
                 when not dialyzer ->
  ...
  defp pat_segment({:bin_element, l, val, size0, type0}, st) do
    ...
    {r_ibitstr(anno: r_a(anno: anno), val: pval, size: psize,
         unit: r_c_literal(val: unit), type: r_c_literal(val: type),
         flags: r_c_literal(val: flags)),
       st2}
  end
  ...
  defp pat_alias(r_c_var(name: v1) = var,
            r_c_alias(var: r_c_var(name: v2), pat: pat) = alias) do
    cond do
      v1 === v2 ->
        alias
      true ->
  ...
  defp pat_alias(r_c_alias(var: r_c_var(name: v1) = var1, pat: p1),
            r_c_alias(var: r_c_var(name: v2) = var2, pat: p2)) do
    pat = pat_alias(p1, p2)
    cond do
      v1 === v2 ->
  ...
  defp pat_alias(r_ibinary(segments: [_ | _] = segs1) = p,
            r_ibinary(segments: [s0 | segs2])) do
    r_ibitstr(anno: r_a(anno: anno) = a) = s0
    s = r_ibitstr(s0, anno: r_a(a, anno: [:sequential_match | anno]))
    r_ibinary(p, segments: segs1 ++ [s | segs2])
  end

  defp pat_alias(r_ibinary(segments: [s0 | segs1]) = p,
            r_ibinary(segments: [])) do
    r_ibitstr(anno: r_a(anno: anno) = a) = s0
    s = r_ibitstr(s0, anno: r_a(a, anno: [:sequential_match | anno]))
  ...
  defp new_fun_name(type, r_core(fcount: c) = st) when is_integer(c) do
    {:erlang.list_to_atom(type ++ '$^' ++ :erlang.integer_to_list(c)),
  ...
  defp bad_generator(ps, generator, arg) do
    anno = get_anno(arg)
    tuple = ann_c_tuple(anno,
                          [r_c_literal(val: :bad_generator), generator])
    call = r_icall(anno: r_a(anno: anno),
               module: r_c_literal(anno: anno, val: :erlang),
               name: r_c_literal(anno: anno, val: :error), args: [tuple])
    r_iclause(anno: r_a(anno: [:compiler_generated]), pats: ps,
        guard: [], body: [call])
  end

  defp function_clause(ps, lineAnno) do
    fail_clause(ps, lineAnno,
                  ann_c_tuple(lineAnno, [r_c_literal(val: :function_clause) | ps]))
  end

  defp fail_clause(pats, anno, arg) do
    r_iclause(anno: r_a(anno: [:compiler_generated]), pats: pats,
        guard: [],
        body: [r_iprimop(anno: r_a(anno: anno), name: r_c_literal(val: :match_fail),
                   args: [arg])])
  end

  defp right_assoc({:op, l1, op, {:op, l2, op, e1, e2}, e3}, op) do
    right_assoc({:op, l2, op, e1, {:op, l1, op, e2, e3}},
                  op)
  end
  ...
  defp annotate_cons(a, h, t, r_core(dialyzer: dialyzer)) do
    case (dialyzer) do
      true ->
        node = :cerl.ann_c_cons(a, :cerl.c_var(:any),
                                  :cerl.c_var(:any))
  ...
  Record.defrecord(:r_known, :known, base: [], ks: [],
                                 prev_ks: [])
  defp known_init() do
    r_known()
  end
  ...
  defp known_start_group(r_known(base: oldBase, ks: ks,
              prev_ks: prevKs) = k) do
  ...
  defp known_end_group(r_known(base: [_ | oldBase],
              prev_ks: [_ | oldPrevKs]) = k) do
  ...
  defp known_bind(r_known(prev_ks: [prevKs0 | oldPrevKs]) = k,
            boundVs) do
  ...
  defp known_in_fun(r_known(base: [baseKs | _], ks: ks0,
              prev_ks: [prevKs | _]) = k,
            name) do
  ...
  defp do_uclause(r_iclause(anno: a0, pats: ps0, guard: g0, body: b0),
            ks0, st0) do
    {ps1, pg0, pvs, pus, st1} = upattern_list(ps0, ks0, st0)
    anno = r_a(a0, :anno)
    {pg, a} = (case (member(:skip_clause, anno)) do
                 true ->
    ...
    used = intersection(union([pu, gu, used_in_any(b1)]),
                          known_get(ks0))
    new = union([pn, gn, new_in_any(b1)])
    {r_iclause(anno: a, pats: ps1, guard: g1, body: b1), pvs, used,
       new, st3}
  end
  ...
  defp uguard(pg, gs0, ks, st0) do
    {gs3, st5} = foldr(fn t, {gs1, st1} ->
                            {l, st2} = new_var(st1)
                            {r, st3} = new_var(st2)
                            {[r_iset(var: l, arg: t)] ++ droplast(gs1) ++ [r_iset(var: r,
                                                                          arg: last(gs1)),
                                                                          r_icall(anno: r_a(),
  ...
  defp uexprs([r_imatch(anno: a, pat: p0, arg: arg, fc: fc) | les],
            ks, st0) do
    case (upat_is_new_var(p0, ks)) do
      ...
      false when les === [] ->
        ...
        uexprs(lps ++ [r_icase(anno: a, args: [la0], clauses: [mc],
                           fc: fc)],
                 ks, st1)
      false ->
        mc = r_iclause(anno: a, pats: [p0], guard: [], body: les)
        uexprs([r_icase(anno: a, args: [arg], clauses: [mc], fc: fc)],
                 ks, st0)
    end
  end
  ...
  defp uexprs([le0 | les0], ks0, st0) do
    ...
    {les1, ks, st2} = uexprs(les0,
                               known_union(ks0, r_a(get_anno(le1), :ns)), st1)
    {[le1 | les1], ks, st2}
  end
  ...
  defp uexprs_iset([r_iset(anno: a0, var: v, arg: arg0) = le0 | les0],
            new0, ks0, st0) do
    case (uexpr_need_known(arg0)) do
      ...
      false ->
        ...
        a = r_a(a0, us: del_element(r_c_var(v, :name), us), 
  ...
  defp mark_compiler_generated(r_c_cons(anno: a, hd: h, tl: t)) do
    ann_c_cons([:compiler_generated | a],
                 mark_compiler_generated(h), mark_compiler_generated(t))
  end
  ...
  defp uexpr(r_iset(anno: a, var: v, arg: a0), ks, st0) do
    ...
    {r_iset(anno: r_a(a, us: del_element(r_c_var(v, :name),
                                    r_a(get_anno(a1), :us)), 
  ...
  defp uexpr(r_iletrec(anno: a, defs: fs0, body: b0), ks, st0) do
    {fs1, st1} = mapfoldl(fn {name, f0}, s0 ->
                               {f1, s1} = uexpr(f0, ks, s0)
                               {{name, f1}, s1}
                          end,
                            st0, fs0)
    {b1, _, st2} = uexprs(b0, ks, st1)
    used = used_in_any(map(fn {_, f} ->
                                f
                           end,
                             fs1) ++ b1)
    {r_iletrec(anno: r_a(a, us: used,  ns: []), defs: fs1, body: b1),
       st2}
  end

  defp uexpr(r_icase(anno: r_a(anno: anno) = a, args: as0,
              clauses: cs0, fc: fc0),
            ks, st0) do
    ...
    new = (case (member(:list_comprehension, anno)) do
             true ->
               []
             false ->
               new_in_all(cs1)
           end)
    {r_icase(anno: r_a(a, us: used,  ns: new), args: as1,
         clauses: cs1, fc: fc1),
       st3}
  end

  defp uexpr(r_ifun(anno: a0, id: id, vars: as, clauses: cs0,
              fc: fc0, name: name) = fun0,
            ks0, st0) do
    {fun1, st2} = (case (known_get(ks0)) do
                     [] ->
                       {fun0, st0}
                     [_ | _] ->
    ...
    used = subtract(intersection(used_in_any(cs3),
                                   known_get(ks1)),
                      avs)
    a1 = r_a(a0, us: used,  ns: [])
    {r_ifun(anno: a1, id: id, vars: as, clauses: cs3, fc: fc1,
         name: name),
       st4}
  end
  ...
  defp uexpr(r_icall(anno: a, module: mod, name: name, args: as),
            _, st) do
    used = union([lit_vars(mod), lit_vars(name),
                                     lit_list_vars(as)])
    {r_icall(anno: r_a(a, us: used), module: mod, name: name,
         args: as),
       st}
  end

  defp uexpr(r_itry(anno: a, args: as0, vars: vs, body: bs0,
              evars: evs, handler: hs0),
            ks, st0) do
    {as1, _, st1} = uexprs(as0, ks, st0)
    argKs = known_union(ks, new_in_any(as1))
    {bs1, _, st2} = uexprs(bs0, argKs, st1)
    {hs1, _, st3} = uexprs(hs0, ks, st2)
    used = intersection(used_in_any(bs1 ++ hs1 ++ as1),
                          known_get(ks))
    {r_itry(anno: r_a(a, us: used,  ns: []), args: as1, vars: vs,
         body: bs1, evars: evs, handler: hs1),
       st3}
  end
  ...
  defp uexpr(r_ireceive1(anno: a, clauses: cs0), ks, st0) do
    ...
    {r_ireceive1(anno: r_a(a, us: used_in_any(cs1), 
                    ns: new_in_all(cs1)),
         clauses: cs1),
       st1}
  end

  defp uexpr(r_ireceive2(anno: a, clauses: cs0, timeout: te0,
              action: tes0),
            ks, st0) do
    ...
    {r_ireceive2(anno: r_a(a, us: used,  ns: new), clauses: cs1,
         timeout: te1, action: tes1),
       st3}
  end
  ...
  defp uexpr(r_c_opaque() = opaque, _, st) do
    {set_anno(opaque, r_a(us: [], anno: get_anno(opaque))),
       st}
  end
  ...
  defp upattern(r_c_var(name: v) = var, ks, st0) do
    case (is_element(v, known_get(ks))) do
      true ->
        ...
        test = r_icall(anno: r_a(anno: lA, us: add_element(n, [v])),
                   module: r_c_literal(val: :erlang), name: r_c_literal(val: :"=:="),
                   args: [new, var])
        {new, [test], [n], [], st1}
      false ->
  ...
  defp upattern(r_c_cons(hd: h0, tl: t0) = cons, ks, st0) do
    ...
    {t1, tg, tv, tu, st2} = upattern(t0,
                                       known_union(ks, hv), st1)
    {r_c_cons(cons, hd: h1,  tl: t1), hg ++ tg, union(hv, tv),
       union(hu, tu), st2}
  end
  ...
  defp upattern(r_imappair(op: r_c_literal(val: :exact), key: k0, val: v0) = pair,
            ks, st0) do
  ...
  defp upattern(r_c_alias(var: v0, pat: p0) = alias, ks, st0) do
    ...
    {p1, pg, pv, pu, st2} = upattern(p0,
                                       known_union(ks, vv), st1)
    {r_c_alias(alias, var: v1,  pat: p1), vg ++ pg, union(vv, pv),
       union(vu, pu), st2}
  end
  ...
  defp upattern_list([p0 | ps0], ks, st0) do
    ...
    {ps1, psg, psv, psu, st2} = upattern_list(ps0,
                                                known_union(ks, pv), st1)
  ...
  defp upat_bin([p0 | ps0], ks, bs, st0) do
    {p1, pg, pv, pu, bs1, st1} = upat_element(p0, ks, bs,
                                                st0)
    {ps1, psg, psv, psu, st2} = upat_bin(ps0,
                                           known_union(ks, pv), bs1, st1)
    {[p1 | ps1], pg ++ psg, union(pv, psv), union(pu, psu),
       st2}
  end
  ...
  defp rename_shadowing_clause(r_iclause(pats: ps0, guard: g0, body: b0) = c, ks,
            st0) do
    subs = {[], []}
  ...
  defp ren_pat(r_c_var(name: v) = old, ks, {isub0, osub0} = subs,
            st0) do
  ...
  defp ren_pat(r_c_alias(var: var0, pat: pat0) = alias, ks,
            {_, _} = subs0, st0) do
  ...
  defp ren_pat(r_ibinary(segments: es0) = p, ks, {isub, osub0}, st0) do
    {es, _Isub, osub, st} = ren_pat_bin(es0, ks, isub,
                                          osub0, st0)
  ...
  defp ren_pat(p, ks0, {_, _} = subs0, st0) do
    ...
    {:cerl.ann_make_data(anno, :cerl.data_type(p), es),
       subs, st}
  end

  defp ren_pat_bin([r_ibitstr(val: val0, size: sz0) = e | es0], ks, isub0,
            osub0, st0) do
    sz = ren_get_subst(sz0, isub0)
    {val, {_, osub1}, st1} = ren_pat(val0, ks,
                                       {isub0, osub0}, st0)
    isub1 = (case (val0) do
               r_c_var() ->
    ...
    {es, isub, osub, st} = ren_pat_bin(es0, ks, isub1,
                                         osub1, st1)
  ...
  defp ren_pat_map([r_imappair(val: val0) = mapPair | es0], ks, subs0,
            st0) do
  ...
  defp cbody(b0, nifs, st0) do
    {b1, _, _, st1} = cexpr(b0, [], st0)
    b2 = (case (:sets.is_element(r_core(st1, :function),
                                   nifs)) do
            true ->
              r_c_fun(body: body0) = b1
              body1 = r_c_seq(arg: r_c_primop(name: r_c_literal(val: :nif_start), args: []),
                          body: body0)
  ...
  defp cclause(r_iclause(anno: r_a(anno: anno), pats: ps0, guard: g0,
              body: b0),
            exp, st0) do
  ...
  defp cpat_map_pairs([r_imappair(anno: r_a(anno: anno), op: op, key: key0,
               val: val0) |
               t]) do
  ...
  defp cpat_bin_seg(r_ibitstr(anno: r_a(anno: anno), val: e, size: sz0,
              unit: unit, type: type, flags: flags)) do
    {sz, _, _} = cexprs(sz0, [], r_core())
    r_c_bitstr(anno: anno, val: e, size: sz, unit: unit, type: type,
        flags: flags)
  end
  ...
  defp cexprs([le], as, st0) do
    ...
    cond do
      ...
      true ->
        {r, st2} = new_var(st1)
        {r_c_let(anno: get_lineno_anno(ce), vars: [r | make_vars(es)],
             arg: ce, body: :core_lib.make_values([r | exp])),
           union(us, as), st2}
    end
  end

  defp cexprs([r_iset(anno: r_a(anno: a), var: v, arg: a0) | les],
            as0, st0) do
    {ces, as1, st1} = cexprs(les, as0, st0)
    {a1, es, us, st2} = cexpr(a0, as1, st1)
    {r_c_let(anno: a, vars: [v | make_vars(es)], arg: a1,
         body: ces),
       union(us, as1), st2}
  end
  ...
  defp cexprs([le | les], as0, st0) do
    ...
    cond do
      ...
      true ->
        {r, st3} = new_var(st2)
        {r_c_let(vars: [r | make_vars(es)], arg: ce, body: ces),
           union(us, as1), st3}
    end
  end

  defp cexpr(r_iletrec(anno: a, defs: fs0, body: b0), as, st0) do
    {fs1, {_, st1}} = mapfoldl(fn {{_Name, _Arity} = nA,
                                     f0},
                                    {used, s0} ->
    ...
    {r_c_letrec(anno: r_a(a, :anno), defs: fs1, body: b1), exp,
       r_a(a, :us), st2}
  end

  defp cexpr(r_icase(anno: a, args: largs, clauses: lcs, fc: lfc),
            as, st0) do
    exp = intersection(r_a(a, :ns), as)
    {cargs, st1} = foldr(fn la, {cas, sta} ->
    ...
    {r_c_case(anno: r_a(a, :anno), arg: :core_lib.make_values(cargs),
         clauses: ccs ++ [cfc]),
       exp, r_a(a, :us), st4}
  end
  ...
  defp cexpr(r_ireceive1(anno: a, clauses: lcs), as, st0) do
    ...
    action = :core_lib.make_values(:lists.duplicate(1 + length(exp),
                                                      true__))
    {r_c_receive(anno: r_a(a, :anno), clauses: ccs,
         timeout: r_c_literal(val: :infinity), action: action),
       exp, r_a(a, :us), st1}
  end

  defp cexpr(r_ireceive2(anno: a, clauses: lcs, timeout: lto,
              action: les),
            as, st0) do
    exp = intersection(r_a(a, :ns), as)
    ...
    {r_c_receive(anno: r_a(a, :anno), clauses: ccs, timeout: cto,
         action: ces),
       exp, r_a(a, :us), st3}
  end

  defp cexpr(r_itry(anno: a, args: la, vars: vs0, body: lb,
              evars: evs, handler: lh),
            _As, st0) do
    ...
    vs = vs0 ++ (for v <- asExp do
                   r_c_var(name: v)
                 end)
    {r_c_try(anno: r_a(a, :anno), arg: ca, vars: vs, body: cb,
  ...
  defp cexpr(r_ifun(anno: r_a(us: us0) = a0, name: {:named, name},
              fc: r_iclause(pats: ps)) = fun0,
            as, st0) do
  ...
  defp cexpr(r_iapply(anno: a, op: op, args: args), _As, st) do
    {r_c_apply(anno: r_a(a, :anno), op: op, args: args), [],
       r_a(a, :us), st}
  end

  defp cexpr(r_icall(anno: a, module: mod, name: name, args: args),
            _As, st0) do
    anno = r_a(a, :anno) -- [:v3_core]
    case (not :cerl.is_c_atom(mod) and member(:tuple_calls,
                                                r_core(st0, :opts))) do
      true ->
        ...
        tupleGuardExpr = :cerl.c_let([tupleSizeVar],
                                       c_call_erl(:tuple_size, [tupleVar]),
                                       c_call_erl(:">",
                                                    [tupleSizeVar,
                                                         :cerl.c_int(0)]))
        tupleGuard = :cerl.c_try(tupleGuardExpr, [tryVar],
                                   tryVar, [:cerl.c_var(:T), :cerl.c_var(:R)],
                                   :cerl.c_atom(false))
                                   ...
                                   :cerl.c_let([tupleArgsVar],
                                                 ...
                                                 c_call_erl(:apply,
                                                              [tupleModVar,
                                                                   name,
                                                                       tupleArgsVar])))
        tupleClause = :cerl.ann_c_clause(genAnno, [tupleVar],
                                           tupleGuard, tupleApply)
        {otherVar, st5} = new_var(genAnno, st4)
        otherApply = :cerl.ann_c_call(genAnno, otherVar, name,
                                        args)
        otherClause = :cerl.ann_c_clause(genAnno, [otherVar],
                                           otherApply)
        {:cerl.ann_c_case(genAnno, mod,
                            [tupleClause, otherClause]),
           [], r_a(a, :us), st5}
      false ->
        {r_c_call(anno: anno, module: mod, name: name, args: args), [],
           r_a(a, :us), st0}
    end
  end
  ...
  defp cexpr(r_iprimop(anno: a, name: name, args: args), _As, st) do
    {r_c_primop(anno: r_a(a, :anno), name: name, args: args), [],
       r_a(a, :us), st}
  end
  ...
  defp cexpr(r_iprotect(anno: a, body: es), _As, st0) do
    ...
    {r_c_try(anno: r_a(a, :anno), arg: ce, vars: [v], body: v,
         evars: vs, handler: r_c_literal(val: false)),
       [], r_a(a, :us), st1}
  end

  defp cexpr(r_ibinary(anno: r_a(anno: anno, us: us), segments: segs),
            _As, st) do
  ...
  defp cfun(r_ifun(anno: a, id: id, vars: args, clauses: lcs,
              fc: lfc),
            _As, st0) do
    {ccs, st1} = cclauses(lcs, [], st0)
    {cfc, st2} = cclause(lfc, [], st1)
    anno = r_a(a, :anno)
    {r_c_fun(anno: id ++ anno, vars: args,
         body: r_c_case(anno: anno,
  ...
  defp c_call_erl(fun, args) do
    ...
    :cerl.ann_c_call(as, :cerl.c_atom(:erlang),
                       :cerl.c_atom(fun), args)
  end

  defp c_add_dummy_export(r_c_clause(body: b0) = c, [_ | _] = exp, st0) do
    {v, st1} = new_var(st0)
    b = r_c_let(vars: [v], arg: b0,
  ...
  defp lexpr(r_c_receive(clauses: [], timeout: timeout0,
              action: action),
            st0) do
    false__ = r_c_literal(val: false)
    true__ = r_c_literal(val: true)
    {timeout, outer0, st1} = (case (is_safe(timeout0)) do
                                true ->
                                  {timeout0, false__, st0}
                                false ->
                                  {timeoutVar, sti0} = new_var(st0)
                                  outerLet = r_c_let(vars: [timeoutVar],
                                                 arg: timeout0, body: false__)
                                  {timeoutVar, outerLet, sti0}
                              end)
    maybeIgnore = (case (timeout) do
    ...
    applyLoop = r_c_apply(anno: [:dialyzer_ignore], op: loopFun,
                    args: [])
    afterCs = [r_c_clause(anno: maybeIgnore, pats: [true__],
                   guard: true__, body: action),
                   r_c_clause(anno: [:compiler_generated, :dialyzer_ignore],
                       pats: [false__], guard: true__, body: applyLoop)]
    {timeoutBool, st3} = new_var(st2)
    timeoutCase = r_c_case(anno: [:receive_timeout],
                      arg: timeoutBool, clauses: afterCs)
    timeoutLet = r_c_let(vars: [timeoutBool],
                     arg: primop(:recv_wait_timeout, [timeout]),
                     body: timeoutCase)
    fun = r_c_fun(vars: [], body: timeoutLet)
    letrec = r_c_letrec(anno: [:letrec_goto, :no_inline],
                 defs: [{loopFun, fun}], body: applyLoop)
    outer = (case (outer0) do
               r_c_let() ->
  ...
  defp lexpr(r_c_receive(anno: recvAnno, clauses: cs0,
              timeout: timeout0, action: action),
            st0) do
    false__ = r_c_literal(val: false)
    true__ = r_c_literal(val: true)
    {timeout, outer0, st1} = (case (is_safe(timeout0)) do
    ...
    recvNextC = r_c_clause(anno: [:compiler_generated,
                             :dialyzer_ignore],
                    pats: [r_c_var(name: :Other)], guard: true__, body: recvNext)
    cs = cs1 ++ [recvNextC]
    {msg, st3} = new_var(st2)
    {msgCase, st4} = split_case(r_c_case(anno: recvAnno, arg: msg,
                                    clauses: cs),
                                  st3)
    afterCs = [r_c_clause(pats: [true__], guard: true__,
                   body: action),
                   r_c_clause(anno: [:dialyzer_ignore], pats: [false__],
                       guard: true__, body: applyLoop)]
    ...
    peekCs = [r_c_clause(pats: [true__], guard: true__,
                  body: msgCase),
                  r_c_clause(anno: maybeIgnore, pats: [false__], guard: true__,
                      body: timeoutLet)]
    peekCase = r_c_case(arg: peekSucceeded, clauses: peekCs)
    peekLet = r_c_let(vars: [peekSucceeded, msg],
  ...
  defp split_case(r_c_case(anno: caseAnno, arg: arg,
              clauses: cs0) = case0,
            st0) do
    args = (case (arg) do
              r_c_values(es: es) ->
    ...
    case (split_clauses(cs0, varArgs, caseAnno, st1)) do
      :none ->
        {case0, st0}
      {preCase, aftCs, st2} ->
        aftCase = r_c_case(case0, arg: :core_lib.make_values(varArgs), 
                             clauses: aftCs)
  ...
  defp split_letify([], [], body, [_ | _] = vsAcc,
            [_ | _] = argAcc) do
    r_c_let(vars: reverse(vsAcc),
        arg: :core_lib.make_values(reverse(argAcc)), body: body)
  end

  defp split_case_letrec(r_c_fun(anno: funAnno0) = fun0, body,
            r_core(gcount: c) = st0) do
    funAnno = [:compiler_generated | funAnno0]
    fun = r_c_fun(fun0, anno: funAnno)
    anno = [:letrec_goto, :no_inline]
    defFunName = goto_func(c)
    letrec = r_c_letrec(anno: anno,
                 defs: [{r_c_var(name: defFunName), fun}], body: body)
      ...
      :none ->
        case (split_clause(c0, st0)) do
          :none ->
            :none
          {ps, nested, st1} ->
            {case__, st2} = split_reconstruct(args, ps, nested, c0,
                                                caseAnno, st1)
            {case__, cs0, st2}
        end
      {case0, cs, st} ->
  ...
  defp goto_func(count) do
    {:erlang.list_to_atom('label^' ++ :erlang.integer_to_list(count)),
       0}
  end

  defp split_reconstruct(args, ps, nil, r_c_clause(anno: anno) = c0, caseAnno,
            st0) do
    c = r_c_clause(c0, pats: ps)
    {fc, st1} = split_fc_clause(ps, anno, st0)
    {r_c_case(anno: caseAnno, arg: :core_lib.make_values(args),
         clauses: [c, fc]),
       st1}
  end

  defp split_reconstruct(args, ps, {:split, splitArgs, pat, nested}, c,
            caseAnno, st) do
  ...
  defp split_reconstruct(args, ps,
            {:split, splitArgs, wrap, pat, nested},
            r_c_clause(anno: anno) = c0, caseAnno, st0) do
    {innerCase, st1} = split_reconstruct(splitArgs, [pat],
                                           nested, c0, caseAnno, st0)
    {fc, st2} = split_fc_clause(args, anno, st1)
    wrapped = wrap.(innerCase)
    c = r_c_clause(c0, pats: ps,  guard: r_c_literal(val: true), 
                body: wrapped)
    {r_c_case(anno: caseAnno, arg: :core_lib.make_values(args),
         clauses: [c, fc]),
       st2}
  ...
  defp split_fc_clause(args, anno0, r_core(gcount: count) = st0) do
    ...
    {r_c_clause(anno: [:dialyzer_ignore | anno], pats: vars,
         guard: r_c_literal(val: true), body: apply),
       st1}
  end
  ...
  defp split_pat(r_c_binary(anno: anno0, segments: segs0) = bin, st0) do
    ...
    case (split_bin_segments(segs0, vars, st0, [])) do
      ...
      {:size_var, tailVar, wrap, bef, aft, st1} ->
        ...
        {befBin,
           {:split, [tailVar], wrap,
              r_c_binary(bin, anno: anno,  segments: aft), nil},
           st}
      {:sequential_match, bef, aft, st1} ->
        anno = keydelete(:binary_var, 1, anno0)
        {befBin, st} = (case (keyfind(:binary_var, 1, anno0)) do
                          false ->
  ...
  defp size_var_before_bin(r_c_binary(anno: anno0, segments: segments) = bin0, bef,
            st0) do
    case (any(fn r_c_bitstr(anno: anno) ->
  ...
  defp split_map_pat([r_c_map_pair(key: key, val: val) = e0 | es], map0, st0,
            acc) do
  ...
  defp eval_map_key(key, e0, es, map, st0) do
    ...
    {wrap, caseArg, aftMap, st2} = wrap_map_key_fun(key,
                                                      keyVar, mapVar, aftMap0,
                                                      st1)
  ...
  defp wrap_map_key_fun(key, keyVar, mapVar, aftMap, st0) do
    case (is_safe(key)) do
      ...
      false ->
        ...
        {fn body ->
              try = r_c_try(arg: key, vars: [keyVar],
                        body: r_c_values(es: [r_c_literal(val: true), keyVar]), evars: evars,
                        handler: r_c_values(es: [r_c_literal(val: false), r_c_literal(val: false)]))
              r_c_let(vars: [succVar, keyVar], arg: try, body: body)
         end,
           r_c_tuple(es: [succVar, mapVar]), r_c_tuple(es: [r_c_literal(val: true), aftMap]),
           st}
    end
  end
  ...
  defp split_bin_segments_1(r_c_bitstr(val: val, size: size) = s0, segs, vars0, st0,
            acc) do
    vars = (case (val) do
              r_c_var(name: v) ->
                :gb_sets.add(v, vars0)
      ...
      r_c_var(name: sizeVar) ->
        case (:gb_sets.is_member(sizeVar, vars0)) do
          true ->
            ...
            {:size_var, tailVar, wrap, reverse(acc, [tail]),
               [s0 | segs], st}
          false ->
            split_bin_segments(segs, vars, st0, [s0 | acc])
        end
  ...
  defp split_tail_seg(r_c_bitstr(anno: a) = s, segs, st0) do
    ...
    {tailVar,
       r_c_bitstr(anno: a, val: tailVar, size: r_c_literal(val: :all),
           unit: r_c_literal(val: unit), type: r_c_literal(val: :binary),
           flags: r_c_literal(val: [:unsigned, :big])),
       st}
  end
  ...
  defp split_wrap(sizeVar, sizeExpr, st0) do
    ...
    {fn body ->
          try = r_c_try(arg: sizeExpr, vars: [sizeVar], body: sizeVar,
                    evars: evars, handler: r_c_literal(val: :bad_size))
  ...
  defp split_bin_unit_1([r_c_bitstr(type: r_c_literal(val: type), size: size,
               unit: r_c_literal(val: u)) |
               ss],
            gCU) do
    bits = (case ({type, size}) do
              {:utf8, _} ->
                8
              {:utf16, _} ->
                16
  ...
  defp bitstr_vars(segs, vs) do
    foldl(fn r_c_bitstr(val: v, size: s), vs0 ->
  ...
  defp lineno_anno(l, st) do
    ...
    compilerGenerated = (for _ <- [:EFE_DUMMY_GEN],
                               generated do
                           :compiler_generated
                         end)
  ...
  defp insert_nif_start([vF = {v, f = r_c_fun(body: body)} | funs]) do
    case (body) do
      ...
      r_c_letrec(defs: defs, body: letrecBody0) = lR0 ->
        ...
        lR = r_c_letrec(lR0, defs: insert_nif_start(defs), 
                      body: letrecBody)
  ...
  defp add_warning(anno, term,
            r_core(ws: ws, file: [{:file, file}]) = st) do
    case (:erl_anno.generated(anno)) do
      false ->
        r_core(st, ws: [{file,
                      [{:erl_anno.location(anno), :v3_core, term}]} |
                       ws])
      true ->
        st
    end
