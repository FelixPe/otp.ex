defmodule :m_v3_kernel do
  ...
  defp expr(r_c_opaque(anno: a, val: v), _, st) do
    {r_k_opaque(anno: a, val: v), [], st}
  end
  ...
  defp call_type(r_c_var(), r_c_literal(val: a), _, _) when is_atom(a) do
    :call
  end

  defp call_type(r_c_literal(val: a), r_c_var(), _, _) when is_atom(a) do
    :call
  end

  defp call_type(r_c_var(), r_c_var(), _, _) do
    :call
  end

  defp call_type(_, _, _, _) do
    :error
  end
  ...
  defp validate_bin_element_size(r_k_var(), _Anno) do
    :ok
  end
  ...
  defp reorder_bin_int_sort_key(r_iclause()) do
    throw(:not_possible)
  end
  ...
  defp ensure_fixed_size(r_k_bin_end()) do
    :ok
  end
  ...
  defp ubody(r_k_goto(args: as) = goto, _Br, st) do
    au = lit_list_vars(as)
    {goto, au, st}
  end
  ...
  defp bif_returns(r_k_internal(name: :match_fail), rs, st) do
    {rs, st}
  end
