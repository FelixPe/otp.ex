defmodule :m_release_handler do
  ...
  def upgrade_script(app, newDir1) do
    newDir = root_dir_relative_path(newDir1)
  ...
  def consult(file, false) do
    :file.consult(root_dir_relative_path(file))
  end

  def consult(file, masters) do
  ...
  defp root_dir_relative_read_link_info(file) do
    :file.read_link_info(root_dir_relative_path(file))
  end

  defp root_dir_relative_list_dir(file) do
    :file.list_dir(root_dir_relative_path(file))
  end

  defp root_dir_relative_file_delete(file) do
    :file.delete(root_dir_relative_path(file))
  end

  defp root_dir_relative_dir_delete(file) do
