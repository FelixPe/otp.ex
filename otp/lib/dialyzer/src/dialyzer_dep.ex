defmodule :m_dialyzer_dep do
  ...
  defp is_escape_op(:match_fail, 1) do
    false
  end

  defp is_escape_op(:recv_wait_timeout, 1) do
    false
  end
  ...
  defp is_escape_op(:erlang, :error, 1) do
    false
  end

  defp is_escape_op(:erlang, :error, 2) do
    false
  end
  ...
  defp is_literal_op(:recv_wait_timeout, 1) do
    true
  end

  defp is_literal_op(:match_fail, 1) do
    true
  end
  ...
  defp is_literal_op(:erlang, :and, 2) do
    true
  end

  defp is_literal_op(:erlang, :or, 2) do
    true
  end

  defp is_literal_op(:erlang, :not, 1) do
    true
  end

  defp is_literal_op(:erlang, :length, 1) do
    true
  end

  defp is_literal_op(:erlang, :size, 1) do
    true
  end

  defp is_literal_op(:erlang, :fun_info, 1) do
    true
  end

  defp is_literal_op(:erlang, :fun_info, 2) do
    true
  end

  defp is_literal_op(:erlang, :fun_to_list, 1) do
    true
  end

  defp is_literal_op(:erlang, :throw, 1) do
    true
  end

  defp is_literal_op(:erlang, :exit, 1) do
    true
  end

  defp is_literal_op(:erlang, :error, 1) do
    true
  end

  defp is_literal_op(:erlang, :error, 2) do
    true
  end
  ...
  defp set__from_list(list) do
    r_set(set: :sets.from_list(list, [{:version, 2}]))
  end
