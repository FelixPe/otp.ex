defmodule :m_dtls_handshake do
  ...
  def client_hello(host, port, connectionStates, sslOpts, id, renegotiation) do
    client_hello(host, port, <<>>, connectionStates, sslOpts, id, renegotiation, :undefined)
  end
        ...
        throw(
          r_alert(
            ...
            where: %{
              ...
              line: 113,
              file: ~c"otp/lib/ssl/src/dtls_handshake.erl"
            }
          )
        )
    end
