defmodule :m_ssl_crl do
  ...
  def trusted_cert_and_path(cRL, {serialNumber, issuer}, certPath, {db, dbRef}) do
  ...
  defp verify_crl_issuer(cRL, r_cert(otp: oTPCertCandidate), issuer, notIssuer) do
