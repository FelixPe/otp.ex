defmodule :m_ssl_upgrade_server_session_cache_sup do
  ...
  Record.defrecord(:r_ticket_data, :ticket_data, key: :undefined,
                                       ...
                                       max_size: :undefined)
  def start_link() do
    :supervisor.start_link({:local, sup_name(:normal)},
                             :ssl_upgrade_server_session_cache_sup, [])
  end

  def start_link_dist() do
    :supervisor.start_link({:local, sup_name(:dist)},
                             :ssl_upgrade_server_session_cache_sup, [])
  end
  ...
  def start_child(type) do
    ...
    case (workers) do
      0 ->
        case (:supervisor.start_child(supName,
                                        [:ssl_unknown_listener,
                                             :ssl_config.pre_1_3_session_opts(:server)])) do
  ...
  defp sup_name(:dist) do
    :erlang.list_to_atom(:erlang.atom_to_list(:ssl_upgrade_server_session_cache_sup) ++ '_dist')
  end
