defmodule :m_tls_handshake do
    ...
    throw(
      r_alert(
        ...
        where: %{
          ...
          line: 132,
          file: ~c"otp/lib/ssl/src/tls_handshake.erl"
        }
      )
    )
  end
  ...
  def get_tls_handshakes(version, data, buffer, options) do
    get_tls_handshakes_aux(version, :erlang.list_to_binary([buffer, data]), options, [])
  end
  ...
  defp handle_client_hello(
         ...
         %{versions: versions, eccs: supportedECCs, honor_ecc_order: eCCOrder} = sslOpts,
           ...
           case :erlang.get(:log_level) do
             :undefined ->
               :ssl_logger.log(
                 ...
                 %{
                   mfa: {:tls_handshake, :get_tls_handshakes_aux, 4},
                   line: 453,
                   file: ~c"otp/lib/ssl/src/tls_handshake.erl"
                 }
               )
