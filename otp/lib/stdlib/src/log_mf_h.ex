defmodule :m_log_mf_h do
  ...
  def init({dir, maxB, maxF, pred})
    ...
    first = (case (read_index_file(dir)) do
               {:ok, lastWritten} ->
    ...
    case ((try do
      ...
      {:ok, fd} ->
        {:ok,
           r_state(dir: dir, maxB: maxB, maxF: maxF, pred: pred,
  ...
  def handle_event(event, state) do
    r_state(curB: curB, maxB: maxB, curF: curF, maxF: maxF,
    ...
    case ((try do
      ...
      true ->
        ...
        case (:file.write(r_state(newState, :cur_fd),
                            [hi, lo, bin])) do
          :ok ->
            :ok
          {:error, reason} ->
