defmodule :m_io_lib_format do
  ...
  defp modifiers([?t | fmt], args, spec) do
    modifiers(fmt, args, Map.put(spec, :encoding, :unicode))
  end

  defp modifiers([?l | fmt], args, spec) do
    modifiers(fmt, args, Map.put(spec, :strings, false))
  end
  ...
  defp signbit(fl) when fl < 0.0 do
    [?-]
  end
