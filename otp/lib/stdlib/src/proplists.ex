defmodule :m_proplists do
  ...
  def normalize(l, stages) do
    compact(apply_stages(l, stages))
  end

  defp apply_stages(l, [{:aliases, as} | xs]) do
    apply_stages(substitute_aliases(as, l), xs)
  end

  defp apply_stages(l, [{:expand, es} | xs]) do
    apply_stages(expand(es, l), xs)
  end

  defp apply_stages(l, [{:negations, ns} | xs]) do
    apply_stages(substitute_negations(ns, l), xs)
  end

  defp apply_stages(l, []) do
    l
  end
