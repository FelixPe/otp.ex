defmodule :m_string do
  ...
  defp trim_ts([sep | cs1] = str, sep) do
    case cs1 do
      ...
      [cP2 | _]
      when is_integer(sep) and 0 <= sep and
  ...
  def left(string, len, char)
      when is_integer(len) and
             is_integer(char) do
  ...
  def sub_string(string, start, stop)
