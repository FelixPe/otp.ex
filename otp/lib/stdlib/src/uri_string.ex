  ...
  defp normalize_map(uRIMap) do
    normalize_path_segment(
      normalize_scheme_based(
        normalize_undefined_port(normalize_percent_encoding(normalize_case(uRIMap)))
      )
    )
  end
