defmodule :m_lists do
  ...
  def zip3([], [y | ys], [z | zs], {:pad, {x, _, _}} = how) do
    [{x, y, z} | zip3([], ys, zs, how)]
  end

  def zip3([x | xs], [], [z | zs], {:pad, {_, y, _}} = how) do
    [{x, y, z} | zip3(xs, [], zs, how)]
  end

  def zip3([x | xs], [y | ys], [], {:pad, {_, _, z}} = how) do
  ...
  def zipwith3(f, [], [y | ys], [z | zs], {:pad, {x, _, _}} = how) do
    [f.(x, y, z) | zipwith3(f, [], ys, zs, how)]
  end

  def zipwith3(f, [x | xs], [], [z | zs], {:pad, {_, y, _}} = how) do
    [f.(x, y, z) | zipwith3(f, xs, [], zs, how)]
  end

  def zipwith3(f, [x | xs], [y | ys], [], {:pad, {_, _, z}} = how) do
  ...
  def enumerate(index, step, list1)
      when is_integer(index) and
             is_integer(step) do
  ...
  defp umergel([[_ | _] = t1, [h2 | t2], [h3 | t3] | l], acc, :asc) do
    umergel(
      l,
  ...
  defp umergel([[h3 | t3], [h2 | t2], [_ | _] = t1 | l], acc, :desc) do
    umergel(
      l,
      [umerge3_1(t1, [h2 | h3], t2, h2, [], t3, h3) | acc],
      :desc
