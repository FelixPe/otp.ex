defmodule :m_ssh_channel do
  ...
  def start(connectionManager, channelId, callBack,
           cbInitArgs) do
    :ssh_client_channel.start(connectionManager, channelId,
                                callBack, cbInitArgs)
  end
  ...
  def start_link(connectionManager, channelId, callBack,
           cbInitArgs) do
    :ssh_client_channel.start_link(connectionManager,
                                     channelId, callBack, cbInitArgs)
  end

  def start_link(connectionManager, channelId, callBack,
           cbInitArgs, exec) do
    :ssh_client_channel.start_link(connectionManager,
                                     channelId, callBack, cbInitArgs, exec)
  end
