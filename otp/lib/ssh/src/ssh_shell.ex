defmodule :m_ssh_shell do
  ...
  def handle_ssh_msg(
    ...
    :io.put_chars(~c"Connection closed by peer")
    :io.put_chars(error)
  ...
  def handle_ssh_msg(
    ...
    :io.put_chars(~c"logout")
    :io.put_chars(~c"Connection closed")
    {:stop, channelId, state}
  end
  ...
  def handle_ssh_msg(
    ...
    :io.put_chars(~c"Connection closed by peer")
    :io.put_chars(~c"Status: " ++ :erlang.integer_to_list(status))
    {:stop, channelId, state}
  end
