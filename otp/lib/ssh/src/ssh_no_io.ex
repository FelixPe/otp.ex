defmodule :m_ssh_no_io do
  ...
  def yes_no(_, _) do
    :ssh_connection_handler.disconnect(7, ~c"User interaction is not allowed", :ssh_no_io, 35)
  end

  def read_password(_, _) do
    :ssh_connection_handler.disconnect(7, ~c"User interaction is not allowed", :ssh_no_io, 42)
  end

  def read_line(_, _) do
    :ssh_connection_handler.disconnect(7, ~c"User interaction is not allowed", :ssh_no_io, 48)
  end

  def format(_, _) do
    :ssh_connection_handler.disconnect(7, ~c"User interaction is not allowed", :ssh_no_io, 54)
  end
end
