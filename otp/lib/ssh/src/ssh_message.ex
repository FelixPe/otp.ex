defmodule :m_ssh_message do
  ...
  def encode(r_ssh_msg_channel_data(recipient_channel: recipient, data: data)) do
    <<94::size(8)-unsigned-big-integer, recipient::size(32)-unsigned-big-integer,
      byte_size(data)::size(32)-unsigned-big-integer, data::binary>>
  end
  ...
  def encode(
    ...
    <<95::size(8)-unsigned-big-integer, recipient::size(32)-unsigned-big-integer,
      dataType::size(32)-unsigned-big-integer, byte_size(data)::size(32)-unsigned-big-integer,
      data::binary>>
  end
  ...
  def encode(r_ssh_msg_userauth_request(user: user, service: service, method: method, data: data)) do
    <<50::size(8)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(user))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_userauth_banner(message: banner, language: lang)) do
    <<53::size(8)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(banner))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_userauth_pk_ok(algorithm_name: alg, key_blob: keyBlob)) do
    <<60::size(8)-unsigned-big-integer,
      ...
      cond do
        ...
        alg == :undefined ->
          <<>>
      end::binary, byte_size(keyBlob)::size(32)-unsigned-big-integer, keyBlob::binary>>
  end

  def encode(r_ssh_msg_userauth_passwd_changereq(prompt: prompt, language: lang)) do
    <<60::size(8)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(prompt))::size(32)-unsigned-big-integer,
  ...
  def encode(
    ...
    <<60::size(8)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(name))::size(32)-unsigned-big-integer,
        :unicode.characters_to_binary(name)::binary>>::binary,
      <<byte_size(:unicode.characters_to_binary(inst))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_userauth_info_response(num_responses: num, data: data)) do
    :lists.foldl(
      fn response, acc ->
        <<acc::binary,
          <<byte_size(:unicode.characters_to_binary(response))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_disconnect(code: code, description: desc, language: lang)) do
    <<1::size(8)-unsigned-big-integer, code::size(32)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(desc))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_service_request(name: service)) do
    <<5::size(8)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(service))::size(32)-unsigned-big-integer,
  ...
  def encode(
    ...
    <<20::size(8)-unsigned-big-integer, cookie::binary,
      byte_size(:ssh_bits.name_list(keyAlgs))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(keyAlgs)::binary,
      byte_size(:ssh_bits.name_list(hostKeyAlgs))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(hostKeyAlgs)::binary,
      byte_size(:ssh_bits.name_list(encAlgC2S))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(encAlgC2S)::binary,
      byte_size(:ssh_bits.name_list(encAlgS2C))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(encAlgS2C)::binary,
      byte_size(:ssh_bits.name_list(macAlgC2S))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(macAlgC2S)::binary,
      byte_size(:ssh_bits.name_list(macAlgS2C))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(macAlgS2C)::binary,
      byte_size(:ssh_bits.name_list(compAlgS2C))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(compAlgS2C)::binary,
      byte_size(:ssh_bits.name_list(compAlgC2S))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(compAlgC2S)::binary,
      byte_size(:ssh_bits.name_list(langC2S))::size(32)-unsigned-big-integer,
      :ssh_bits.name_list(langC2S)::binary,
      byte_size(:ssh_bits.name_list(langS2C))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_kexdh_reply(public_host_key: {key, sigAlg}, f: f, h_sig: signature)) do
    ...
    <<31::size(8)-unsigned-big-integer, byte_size(encKey)::size(32)-unsigned-big-integer,
      encKey::binary, :ssh_bits.mpint(f)::binary,
      byte_size(encSign)::size(32)-unsigned-big-integer, encSign::binary>>
  end
  ...
  def encode(r_ssh_msg_kex_dh_gex_reply(public_host_key: {key, sigAlg}, f: f, h_sig: signature)) do
    ...
    <<33::size(8)-unsigned-big-integer, byte_size(encKey)::size(32)-unsigned-big-integer,
      encKey::binary, :ssh_bits.mpint(f)::binary,
      byte_size(encSign)::size(32)-unsigned-big-integer, encSign::binary>>
  end

  def encode(r_ssh_msg_kex_ecdh_init(q_c: q_c)) do
    <<30::size(8)-unsigned-big-integer, byte_size(q_c)::size(32)-unsigned-big-integer,
      q_c::binary>>
  end
  ...
  def encode(r_ssh_msg_kex_ecdh_reply(public_host_key: {key, sigAlg}, q_s: q_s, h_sig: sign)) do
    ...
    <<31::size(8)-unsigned-big-integer, byte_size(encKey)::size(32)-unsigned-big-integer,
      encKey::binary, byte_size(q_s)::size(32)-unsigned-big-integer, q_s::binary,
      byte_size(encSign)::size(32)-unsigned-big-integer, encSign::binary>>
  end

  def encode(r_ssh_msg_ignore(data: data)) do
    <<2::size(8)-unsigned-big-integer,
      <<byte_size(:unicode.characters_to_binary(data))::size(32)-unsigned-big-integer,
  ...
  def encode(r_ssh_msg_debug(always_display: bool, message: msg, language: lang)) do
    <<4::size(8)-unsigned-big-integer,
      ...
      <<byte_size(:unicode.characters_to_binary(msg))::size(32)-unsigned-big-integer,
  ...
  def ssh2_pubkey_encode(r_RSAPublicKey(modulus: n, publicExponent: e)) do
    <<byte_size("ssh-rsa")::size(32)-unsigned-big-integer, "ssh-rsa"::binary,
      :ssh_bits.mpint(e)::binary, :ssh_bits.mpint(n)::binary>>
  end

  def ssh2_pubkey_encode({y, r_Dss_Parms(p: p, q: q, g: g)}) do
    <<byte_size("ssh-dss")::size(32)-unsigned-big-integer, "ssh-dss"::binary,
  ...
  def ssh2_pubkey_encode({r_ECPoint(point: q), {:namedCurve, oID}})
      when oID == {1, 3, 101, 112} or oID == {1, 3, 101, 113} do
    {keyType, _} = oid2ssh_curvename(oID)

    <<byte_size(keyType)::size(32)-unsigned-big-integer, keyType::binary,
      byte_size(
        cond do
          is_binary(q) ->
            q
  ...
  def ssh2_pubkey_encode(
    ...
    <<byte_size(keyType)::size(32)-unsigned-big-integer, keyType::binary,
      byte_size(curve)::size(32)-unsigned-big-integer, curve::binary,
      byte_size(
        cond do
          is_binary(key) ->
            key
  ...
  defp ssh2_pubkey_decode2(
         <<sCNL::size(32)-unsigned-big-integer, sshCurveName::size(sCNL)-binary, rest0::binary>>
       ) do
    {pub, rest} =
      case {sshCurveName, rest0} do
        {<<"ecdsa-sha2-", _::binary>>,
         <<_IL::size(32)-unsigned-big-integer, _Curve::size(_IL)-binary,
           _QL::size(32)-unsigned-big-integer, q::size(_QL)-binary, rest1::binary>>} ->
          {q, rest1}

        {<<"ssh-ed", _::binary>>,
         <<_L::size(32)-unsigned-big-integer, key::size(_L)-binary, rest1::binary>>} ->
          {key, rest1}
      end
  ...
  def ssh2_privkey_encode(
    ...
    <<byte_size("ssh-rsa")::size(32)-unsigned-big-integer, "ssh-rsa"::binary,
      :ssh_bits.mpint(n)::binary, :ssh_bits.mpint(e)::binary, :ssh_bits.mpint(d)::binary,
      :ssh_bits.mpint(iQMP)::binary, :ssh_bits.mpint(p)::binary, :ssh_bits.mpint(q)::binary>>
  end

  def ssh2_privkey_encode(r_DSAPrivateKey(version: 0, p: p, q: q, g: g, y: y, x: x)) do
    <<byte_size("ssh-dss")::size(32)-unsigned-big-integer, "ssh-dss"::binary,
      :ssh_bits.mpint(p)::binary, :ssh_bits.mpint(q)::binary, :ssh_bits.mpint(g)::binary,
      :ssh_bits.mpint(y)::binary, :ssh_bits.mpint(x)::binary>>
  end
  ...
  def ssh2_privkey_encode(
    ...
    <<byte_size(curveName)::size(32)-unsigned-big-integer, curveName::binary,
      byte_size(pub)::size(32)-unsigned-big-integer, pub::binary,
      byte_size(priv)::size(32)-unsigned-big-integer, priv::binary>>
  end
  ...
  def ssh2_privkey_encode(
    ...
    <<byte_size(curveName)::size(32)-unsigned-big-integer, curveName::binary,
      byte_size(curveName)::size(32)-unsigned-big-integer, curveName::binary,
      byte_size(q)::size(32)-unsigned-big-integer, q::binary,
      byte_size(priv)::size(32)-unsigned-big-integer, priv::binary>>
  end
  ...
  def ssh2_privkey_decode2(
    ...
    {pub, priv, rest} =
      case {sshCurveName, rest0} do
        {<<"ecdsa-sha2-", _::binary>>,
         <<_IL::size(32)-unsigned-big-integer, _Curve::size(_IL)-binary,
           _QL::size(32)-unsigned-big-integer, pub1::size(_QL)-binary,
           _PrivL::size(32)-unsigned-big-integer, priv1::size(_PrivL)-binary, rest1::binary>>} ->
          {pub1, priv1, rest1}

        {<<"ssh-ed", _::binary>>,
         <<pL::size(32)-unsigned-big-integer, pub1::size(pL)-binary,
           pPL::size(32)-unsigned-big-integer, privPub::size(pPL)-binary, rest1::binary>>} ->
          ^pL = div(pPL, 2)
          <<priv1::size(pL)-binary, _::binary>> = privPub
          {pub1, priv1, rest1}
      end

    oID = ssh_curvename2oid(sshCurveName)

    {r_ECPrivateKey(version: 1, parameters: {:namedCurve, oID}, privateKey: priv, publicKey: pub),
     rest}
  end
  ...
  defp decode_kex_init(
    ...
    names = :string.tokens(ucl(data), ~c",")
  ...
  defp encode_signature(r_RSAPublicKey(), sigAlg, signature) do
    ...
    <<byte_size(signName)::size(32)-unsigned-big-integer, signName::binary,
      byte_size(signature)::size(32)-unsigned-big-integer, signature::binary>>
  end
  ...
  defp encode_signature({r_ECPoint(), {:namedCurve, oID}}, _SigAlg, signature) do
    ...
    <<byte_size(<<sshCurveName::binary>>)::size(32)-unsigned-big-integer,
      <<sshCurveName::binary>>::binary, byte_size(signature)::size(32)-unsigned-big-integer,
      signature::binary>>
  end
  ...
  def ssh_dbg_format(
    ...
    [
      ...
      case msg do
        r_ssh_msg_userauth_request(
          service: ~c"ssh-connection",
          method: ~c"publickey",
          data: <<_, __0::size(32)-unsigned-big-integer, alg::size(__0)-binary, _::binary>>
        ) ->
          :io_lib.format(~c"  data decoded: ~s ... ~n", [alg])

        r_ssh_msg_channel_request(
          request_type: ~c"env",
          data:
            <<__0::size(32)-unsigned-big-integer, var::size(__0)-binary,
              __1::size(32)-unsigned-big-integer, val::size(__1)-binary>>
        ) ->
          :io_lib.format(~c"  data decoded: ~s = ~s~n", [var, val])

        r_ssh_msg_channel_request(
          request_type: ~c"exec",
          data: <<__0::size(32)-unsigned-big-integer, cmnd::size(__0)-binary>>
        ) ->
          :io_lib.format(~c"  data decoded: ~s~n", [cmnd])

        r_ssh_msg_channel_request(
          request_type: ~c"pty-req",
          data:
          ...
          :io_lib.format(
            ~c"  data decoded: terminal = ~s~n                width x height = ~p x ~p~n                pix-width x pix-height = ~p x ~p~n                pty-opts = ~p~n",
            [
              bTermName,
              width,
              height,
  ...
  def ssh_dbg_format(
    ...
    [~c"Received plain text bytes (shown after decryption):\n", :io_lib.format(~c"~p", [bytesPT])]
  end
  ...
  def ssh_dbg_format(
    ...
    [
      ~c"Going to send plain text bytes (shown before encryption):\n",
      :io_lib.format(~c"~p", [bytesPT])
    ]
  end
