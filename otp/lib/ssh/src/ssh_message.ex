defmodule :m_ssh_message do
  ...
  def encode(r_ssh_msg_request_success(data: data)) do
    <<81 :: size(8) - unsigned - big - integer,
        data :: binary>>
  end
  ...
  def encode(r_ssh_msg_channel_open(channel_type: type, sender_channel: sender,
             initial_window_size: window, maximum_packet_size: max,
             data: data)) do
    <<90 :: size(8) - unsigned - big - integer,
        ...
        ::
        binary,
        sender :: size(32) - unsigned - big - integer,
        window :: size(32) - unsigned - big - integer,
  ...
  def encode(r_ssh_msg_channel_open_confirmation(recipient_channel: recipient,
             sender_channel: sender,
             initial_window_size: initWindowSize,
             maximum_packet_size: maxPacketSize, data: data)) do
    <<91 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer,
        sender :: size(32) - unsigned - big - integer,
        initWindowSize :: size(32) - unsigned - big - integer,
  ...
  def encode(r_ssh_msg_channel_open_failure(recipient_channel: recipient, reason: reason,
             description: desc, lang: lang)) do
    <<92 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer,
  ...
  def encode(r_ssh_msg_channel_window_adjust(recipient_channel: recipient,
             bytes_to_add: bytes)) do
    <<93 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer,
        bytes :: size(32) - unsigned - big - integer>>
  end

  def encode(r_ssh_msg_channel_data(recipient_channel: recipient, data: data)) do
    <<94 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer,
        byte_size(data) :: size(32) - unsigned - big - integer,
        data :: binary>>
  end

  def encode(r_ssh_msg_channel_extended_data(recipient_channel: recipient,
             data_type_code: dataType, data: data)) do
    <<95 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer,
        dataType :: size(32) - unsigned - big - integer,
        byte_size(data) :: size(32) - unsigned - big - integer,
        data :: binary>>
  end

  def encode(r_ssh_msg_channel_eof(recipient_channel: recipient)) do
    <<96 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer>>
  end

  def encode(r_ssh_msg_channel_close(recipient_channel: recipient)) do
    <<97 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer>>
  end

  def encode(r_ssh_msg_channel_request(recipient_channel: recipient,
             request_type: type, want_reply: bool, data: data)) do
    <<98 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer,
        byte_size(cond do
                    is_binary(type) ->
                      type
  ...
  def encode(r_ssh_msg_channel_success(recipient_channel: recipient)) do
    <<99 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer>>
  end

  def encode(r_ssh_msg_channel_failure(recipient_channel: recipient)) do
    <<100 :: size(8) - unsigned - big - integer,
        recipient :: size(32) - unsigned - big - integer>>
  end

  def encode(r_ssh_msg_userauth_request(user: user, service: service, method: method,
             data: data)) do
    <<50 :: size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(user))
          ::
          size(32) - unsigned - big - integer,
  ...
  def encode(r_ssh_msg_userauth_failure(authentications: auths,
             partial_success: bool)) do
  ...
  def encode(r_ssh_msg_userauth_banner(message: banner, language: lang)) do
    <<53 :: size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(banner))
          ::
          size(32) - unsigned - big - integer,
            :unicode.characters_to_binary(banner) :: binary>>
        ::
        binary,
        byte_size(cond do
                    is_binary(lang) ->
  ...
  def encode(r_ssh_msg_userauth_passwd_changereq(prompt: prompt, language: lang)) do
    <<60 :: size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(prompt))
          ::
          size(32) - unsigned - big - integer,
            :unicode.characters_to_binary(prompt) :: binary>>
        ::
        binary,
        byte_size(cond do
                    is_binary(lang) ->
  ...
  def encode(r_ssh_msg_userauth_info_request(name: name, instruction: inst,
             language_tag: lang, num_prompts: numPromtps,
             data: data)) do
    <<60 :: size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(name))
          ::
          size(32) - unsigned - big - integer,
            :unicode.characters_to_binary(name) :: binary>>
        ::
        binary,
        <<byte_size(:unicode.characters_to_binary(inst))
          ::
          size(32) - unsigned - big - integer,
            :unicode.characters_to_binary(inst) :: binary>>
        ::
        binary,
        byte_size(cond do
                    is_binary(lang) ->
        ...
        ::
        binary,
        numPromtps :: size(32) - unsigned - big - integer,
        cond do
          is_binary(data) ->
            data
          is_list(data) ->
  ...
  def encode(r_ssh_msg_userauth_info_response(num_responses: num, data: data)) do
    :lists.foldl(fn response, acc ->
                      <<acc :: binary,
                          <<byte_size(:unicode.characters_to_binary(response))
                            ::
                            size(32) - unsigned - big - integer,
                   ...
                   <<61 :: size(8) - unsigned - big - integer,
                       num :: size(32) - unsigned - big - integer>>,
                   data)
  end

  def encode(r_ssh_msg_disconnect(code: code, description: desc,
             language: lang)) do
    <<1 :: size(8) - unsigned - big - integer,
        code :: size(32) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(desc))
          ::
          size(32) - unsigned - big - integer,
            :unicode.characters_to_binary(desc) :: binary>>
        ::
        binary,
        byte_size(cond do
                    is_binary(lang) ->
  ...
  def encode(r_ssh_msg_service_request(name: service)) do
    <<5 :: size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(service))
          ::
          size(32) - unsigned - big - integer,
  ...
  def encode(r_ssh_msg_ext_info(nr_extensions: n, data: data)) do
    :lists.foldl(fn {extName, extVal}, acc ->
                      <<acc :: binary,
                          byte_size(cond do
                                      is_binary(extName) ->
                                        extName
  ...
  def encode(r_ssh_msg_kexinit(cookie: cookie, kex_algorithms: keyAlgs,
             ...
             first_kex_packet_follows: bool, reserved: reserved)) do
    <<20 :: size(8) - unsigned - big - integer,
        cookie :: binary,
        byte_size(:ssh_bits.name_list(keyAlgs))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(keyAlgs) :: binary,
        byte_size(:ssh_bits.name_list(hostKeyAlgs))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(hostKeyAlgs) :: binary,
        byte_size(:ssh_bits.name_list(encAlgC2S))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(encAlgC2S) :: binary,
        byte_size(:ssh_bits.name_list(encAlgS2C))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(encAlgS2C) :: binary,
        byte_size(:ssh_bits.name_list(macAlgC2S))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(macAlgC2S) :: binary,
        byte_size(:ssh_bits.name_list(macAlgS2C))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(macAlgS2C) :: binary,
        byte_size(:ssh_bits.name_list(compAlgS2C))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(compAlgS2C) :: binary,
        byte_size(:ssh_bits.name_list(compAlgC2S))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(compAlgC2S) :: binary,
        byte_size(:ssh_bits.name_list(langC2S))
        ::
        size(32) - unsigned - big - integer,
        :ssh_bits.name_list(langC2S) :: binary,
        byte_size(:ssh_bits.name_list(langS2C))
        ::
        size(32) - unsigned - big - integer,
        ...
        ::
        size(8) - unsigned - big - integer,
        reserved :: size(32) - unsigned - big - integer>>
  end
  ...
  def encode(r_ssh_msg_kexdh_reply(public_host_key: {key, sigAlg}, f: f,
             h_sig: signature)) do
  ...
  def encode(r_ssh_msg_kex_dh_gex_init(e: public)) do
    <<32 :: size(8) - unsigned - big - integer,
        :ssh_bits.mpint(public) :: binary>>
  end

  def encode(r_ssh_msg_kex_dh_gex_reply(public_host_key: {key, sigAlg}, f: f,
             h_sig: signature)) do
    encKey = ssh2_pubkey_encode(key)
    encSign = encode_signature(key, sigAlg, signature)
  ...
  def encode(r_ssh_msg_kex_ecdh_reply(public_host_key: {key, sigAlg}, q_s: q_s,
             h_sig: sign)) do
    encKey = ssh2_pubkey_encode(key)
  ...
  def encode(r_ssh_msg_ignore(data: data)) do
    <<2 :: size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(data))
          ::
          size(32) - unsigned - big - integer,
  ...
  def encode(r_ssh_msg_unimplemented(sequence: seq)) do
    <<3 :: size(8) - unsigned - big - integer,
        seq :: size(32) - unsigned - big - integer>>
  end

  def encode(r_ssh_msg_debug(always_display: bool, message: msg,
             language: lang)) do
    <<4 :: size(8) - unsigned - big - integer,
        ...
        ::
        size(8) - unsigned - big - integer,
        <<byte_size(:unicode.characters_to_binary(msg))
          ::
          size(32) - unsigned - big - integer,
  ...
  def decode(<<80 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             name :: size(__0) - binary,
             bool :: size(8) - unsigned - big - integer,
             data :: binary>>) do
    r_ssh_msg_global_request(name: name, want_reply: erl_boolean(bool), data: data)
  end

  def decode(<<81 :: size(8) - unsigned - big - integer,
             data :: binary>>) do
  ...
  def decode(<<90 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             type :: size(__0) - binary,
             sender :: size(32) - unsigned - big - integer,
             window :: size(32) - unsigned - big - integer,
             max :: size(32) - unsigned - big - integer,
             data :: binary>>) do
    r_ssh_msg_channel_open(channel_type: :erlang.binary_to_list(type),
        sender_channel: sender, initial_window_size: window,
        maximum_packet_size: max, data: data)
  end

  def decode(<<91 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer,
             sender :: size(32) - unsigned - big - integer,
             initWindowSize :: size(32) - unsigned - big - integer,
             maxPacketSize :: size(32) - unsigned - big - integer,
             data :: binary>>) do
    r_ssh_msg_channel_open_confirmation(recipient_channel: recipient, sender_channel: sender,
        initial_window_size: initWindowSize,
        maximum_packet_size: maxPacketSize, data: data)
  end

  def decode(<<92 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer,
             reason :: size(32) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             desc :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             lang :: size(__1) - binary>>) do
    r_ssh_msg_channel_open_failure(recipient_channel: recipient, reason: reason,
        description: ucl(desc), lang: lang)
  end

  def decode(<<93 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer,
             bytes :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_channel_window_adjust(recipient_channel: recipient, bytes_to_add: bytes)
  end

  def decode(<<94 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             data :: size(__0) - binary>>) do
    r_ssh_msg_channel_data(recipient_channel: recipient, data: data)
  end

  def decode(<<95 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer,
             dataType :: size(32) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             data :: size(__0) - binary>>) do
    r_ssh_msg_channel_extended_data(recipient_channel: recipient,
        data_type_code: dataType, data: data)
  end

  def decode(<<96 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_channel_eof(recipient_channel: recipient)
  end

  def decode(<<97 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_channel_close(recipient_channel: recipient)
  end

  def decode(<<98 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             requestType :: size(__0) - binary,
             bool :: size(8) - unsigned - big - integer,
             data :: binary>> = bytes) do
    try do
      r_ssh_msg_channel_request(recipient_channel: recipient,
          request_type: ucl(requestType),
          want_reply: erl_boolean(bool), data: data)
    catch
      _, _ ->
        r_ssh_msg_channel_request(recipient_channel: recipient,
            request_type: :faulty_msg, data: bytes)
    end
  end

  def decode(<<99 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_channel_success(recipient_channel: recipient)
  end

  def decode(<<100 :: size(8) - unsigned - big - integer,
             recipient :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_channel_failure(recipient_channel: recipient)
  end

  def decode(<<50 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             user :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             service :: size(__1) - binary,
             __2 :: size(32) - unsigned - big - integer,
             method :: size(__2) - binary, data :: binary>>) do
    r_ssh_msg_userauth_request(user: ucl(user), service: ucl(service),
        method: ucl(method), data: data)
  end

  def decode(<<51 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             auths :: size(__0) - binary,
             bool :: size(8) - unsigned - big - integer>>) do
    r_ssh_msg_userauth_failure(authentications: ucl(auths),
  ...
  def decode(<<53 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             banner :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             lang :: size(__1) - binary>>) do
    r_ssh_msg_userauth_banner(message: banner, language: lang)
  end

  def decode(<<60 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             name :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             inst :: size(__1) - binary,
             __2 :: size(32) - unsigned - big - integer,
             lang :: size(__2) - binary,
             numPromtps :: size(32) - unsigned - big - integer,
             data :: binary>>) do
    r_ssh_msg_userauth_info_request(name: name, instruction: inst, language_tag: lang,
        num_prompts: numPromtps, data: data)
  end

  def decode(<<60 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             prompt :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             lang :: size(__1) - binary>>) do
    r_ssh_msg_userauth_passwd_changereq(prompt: prompt, language: lang)
  end

  def decode(<<60 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             alg :: size(__0) - binary, keyBlob :: binary>>) do
    r_ssh_msg_userauth_pk_ok(algorithm_name: alg, key_blob: keyBlob)
  end

  def decode(<<61 :: size(8) - unsigned - big - integer,
             num :: size(32) - unsigned - big - integer,
             data :: binary>>) do
    r_ssh_msg_userauth_info_response(num_responses: num, data: data)
  end

  def decode(<<7 :: size(8) - unsigned - big - integer,
             n :: size(32) - unsigned - big - integer,
             binData :: binary>>) do
    data = bin_foldr(fn bin, acc when length(acc) == n ->
                          {bin, acc}
                        <<__0 :: size(32) - unsigned - big - integer,
                            v0 :: size(__0) - binary,
                            __1 :: size(32) - unsigned - big - integer,
                            v1 :: size(__1) - binary, rest :: binary>>,
                          acc ->
                          {rest,
                             [{:erlang.binary_to_list(v0),
                                 :erlang.binary_to_list(v1)} |
                                  acc]}
                     end,
                       [], binData)
  ...
  def decode(<<20 :: size(8) - unsigned - big - integer,
             cookie :: size(128), data :: binary>>) do
    decode_kex_init(data, [cookie, :ssh_msg_kexinit], 10)
  end

  def decode(<<"dh", 30 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             e :: size(__0) - big - signed - integer - unit(8)>>) do
    r_ssh_msg_kexdh_init(e: e)
  end

  def decode(<<"dh", 31 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             key :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             f :: size(__1) - big - signed - integer - unit(8),
             __2 :: size(32) - unsigned - big - integer,
             hashsign :: size(__2) - binary>>) do
    r_ssh_msg_kexdh_reply(public_host_key: ssh2_pubkey_decode(key), f: f,
        h_sig: decode_signature(hashsign))
  end

  def decode(<<34 :: size(8) - unsigned - big - integer,
             min :: size(32) - unsigned - big - integer,
             n :: size(32) - unsigned - big - integer,
             max :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_kex_dh_gex_request(min: min, n: n, max: max)
  end

  def decode(<<"dh_gex", 30 :: size(8) - unsigned - big - integer,
             n :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_kex_dh_gex_request_old(n: n)
  end

  def decode(<<"dh_gex", 31 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             prime :: size(__0) - big - signed - integer - unit(8),
             __1 :: size(32) - unsigned - big - integer,
             generator
             ::
             size(__1) - big - signed - integer - unit(8)>>) do
    r_ssh_msg_kex_dh_gex_group(p: prime, g: generator)
  end

  def decode(<<32 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             e :: size(__0) - big - signed - integer - unit(8)>>) do
    r_ssh_msg_kex_dh_gex_init(e: e)
  end

  def decode(<<33 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             key :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             f :: size(__1) - big - signed - integer - unit(8),
             __2 :: size(32) - unsigned - big - integer,
             hashsign :: size(__2) - binary>>) do
    r_ssh_msg_kex_dh_gex_reply(public_host_key: ssh2_pubkey_decode(key), f: f,
        h_sig: decode_signature(hashsign))
  end

  def decode(<<"ecdh", 30 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             q_c :: size(__0) - binary>>) do
    r_ssh_msg_kex_ecdh_init(q_c: q_c)
  end

  def decode(<<"ecdh", 31 :: size(8) - unsigned - big - integer,
             __1 :: size(32) - unsigned - big - integer,
             key :: size(__1) - binary,
             __2 :: size(32) - unsigned - big - integer,
             q_s :: size(__2) - binary,
             __3 :: size(32) - unsigned - big - integer,
             sig :: size(__3) - binary>>) do
    r_ssh_msg_kex_ecdh_reply(public_host_key: ssh2_pubkey_decode(key), q_s: q_s,
        h_sig: decode_signature(sig))
  end

  def decode(<<5, __0 :: size(32) - unsigned - big - integer,
             service :: size(__0) - binary>>) do
    r_ssh_msg_service_request(name: ucl(service))
  end

  def decode(<<6, __0 :: size(32) - unsigned - big - integer,
             service :: size(__0) - binary>>) do
    r_ssh_msg_service_accept(name: ucl(service))
  end

  def decode(<<1 :: size(8) - unsigned - big - integer,
             code :: size(32) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             desc :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
  ...
  def decode(<<2 :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             data :: size(__0) - binary>>) do
    r_ssh_msg_ignore(data: data)
  end

  def decode(<<3 :: size(8) - unsigned - big - integer,
             seq :: size(32) - unsigned - big - integer>>) do
    r_ssh_msg_unimplemented(sequence: seq)
  end

  def decode(<<4 :: size(8) - unsigned - big - integer,
             bool :: size(8) - unsigned - big - integer,
             __0 :: size(32) - unsigned - big - integer,
             msg :: size(__0) - binary,
             __1 :: size(32) - unsigned - big - integer,
             lang :: size(__1) - binary>>) do
    r_ssh_msg_debug(always_display: erl_boolean(bool), message: msg,
        language: lang)
  end

  def ssh2_pubkey_encode(r_RSAPublicKey(modulus: n, publicExponent: e)) do
    <<byte_size("ssh-rsa") :: size(32) - unsigned - big - integer,
        "ssh-rsa" :: binary, :ssh_bits.mpint(e) :: binary,
        :ssh_bits.mpint(n) :: binary>>
  end

  def ssh2_pubkey_encode({y, r_Dss_Parms(p: p, q: q, g: g)}) do
    <<byte_size("ssh-dss") :: size(32) - unsigned - big - integer,
        "ssh-dss" :: binary, :ssh_bits.mpint(p) :: binary,
        :ssh_bits.mpint(q) :: binary,
        :ssh_bits.mpint(g) :: binary,
        :ssh_bits.mpint(y) :: binary>>
  end

  def ssh2_pubkey_encode({r_ECPoint(point: q), {:namedCurve, oID}})
  ...
  def ssh2_pubkey_encode(r_ECPrivateKey(parameters: {:namedCurve, oID},
             publicKey: key))
      when oID == {1, 3, 101, 112} or oID == {1, 3, 101,
                                                113} do
    {keyType, _} = oid2ssh_curvename(oID)
  ...
  def ssh2_pubkey_encode(r_ECPrivateKey(parameters: {:namedCurve, oID},
    ...
    <<byte_size(keyType)
      ...
      size(32) - unsigned - big - integer,
        keyType :: binary,
        byte_size(curve) :: size(32) - unsigned - big - integer,
        curve :: binary,
        byte_size(cond do
                    is_binary(key) ->
                      key
  ...
  defp ssh2_pubkey_decode2(<<7 :: size(32) - unsigned - big - integer, "ssh-rsa",
              _EL :: size(32) - unsigned - big - integer,
              e :: size(_EL) - big - signed - integer - unit(8),
              _NL :: size(32) - unsigned - big - integer,
              n :: size(_NL) - big - signed - integer - unit(8),
              rest :: binary>>) do
    {r_RSAPublicKey(modulus: n, publicExponent: e), rest}
  end

  defp ssh2_pubkey_decode2(<<7 :: size(32) - unsigned - big - integer, "ssh-dss",
              _PL :: size(32) - unsigned - big - integer,
              p :: size(_PL) - big - signed - integer - unit(8),
              _QL :: size(32) - unsigned - big - integer,
              q :: size(_QL) - big - signed - integer - unit(8),
              _GL :: size(32) - unsigned - big - integer,
              g :: size(_GL) - big - signed - integer - unit(8),
              _YL :: size(32) - unsigned - big - integer,
              y :: size(_YL) - big - signed - integer - unit(8),
              rest :: binary>>) do
    {{y, r_Dss_Parms(p: p, q: q, g: g)}, rest}
  end

  defp ssh2_pubkey_decode2(<<sCNL :: size(32) - unsigned - big - integer,
              sshCurveName :: size(sCNL) - binary,
              rest0 :: binary>>) do
    {pub, rest} = (case ({sshCurveName, rest0}) do
                     {<<"ecdsa-sha2-", _ :: binary>>,
                        <<_IL :: size(32) - unsigned - big - integer,
                            _Curve :: size(_IL) - binary,
                            _QL :: size(32) - unsigned - big - integer,
                            q :: size(_QL) - binary, rest1 :: binary>>} ->
                       {q, rest1}
                     {<<"ssh-ed", _ :: binary>>,
                        <<_L :: size(32) - unsigned - big - integer,
                            key :: size(_L) - binary, rest1 :: binary>>} ->
                       {key, rest1}
                   end)
    oID = ssh_curvename2oid(sshCurveName)
    {{r_ECPoint(point: pub), {:namedCurve, oID}}, rest}
  end

  def ssh2_privkey_encode(r_RSAPrivateKey(version: :"two-prime", modulus: n, publicExponent: e,
             privateExponent: d, prime1: p, prime2: q,
             coefficient: iQMP)) do
    <<byte_size("ssh-rsa") :: size(32) - unsigned - big - integer,
        "ssh-rsa" :: binary, :ssh_bits.mpint(n) :: binary,
        :ssh_bits.mpint(e) :: binary,
        :ssh_bits.mpint(d) :: binary,
        :ssh_bits.mpint(iQMP) :: binary,
        :ssh_bits.mpint(p) :: binary,
        :ssh_bits.mpint(q) :: binary>>
  end

  def ssh2_privkey_encode(r_DSAPrivateKey(version: 0, p: p, q: q, g: g, y: y, x: x)) do
    <<byte_size("ssh-dss") :: size(32) - unsigned - big - integer,
        "ssh-dss" :: binary, :ssh_bits.mpint(p) :: binary,
        :ssh_bits.mpint(q) :: binary,
        :ssh_bits.mpint(g) :: binary,
        :ssh_bits.mpint(y) :: binary,
        :ssh_bits.mpint(x) :: binary>>
  end

  def ssh2_privkey_encode(r_ECPrivateKey(version: 1, parameters: {:namedCurve, oID},
    ...
    <<byte_size(curveName)
      ...
      size(32) - unsigned - big - integer,
        curveName :: binary,
        byte_size(pub) :: size(32) - unsigned - big - integer,
        pub :: binary,
        byte_size(priv) :: size(32) - unsigned - big - integer,
        priv :: binary>>
  end

  def ssh2_privkey_encode(r_ECPrivateKey(version: 1, parameters: {:namedCurve, oID},
             privateKey: priv, publicKey: q)) do
    {curveName, _} = oid2ssh_curvename(oID)
    <<byte_size(curveName)
      ::
      size(32) - unsigned - big - integer,
        ...
        size(32) - unsigned - big - integer,
        curveName :: binary,
        byte_size(q) :: size(32) - unsigned - big - integer,
        q :: binary,
        byte_size(priv) :: size(32) - unsigned - big - integer,
        priv :: binary>>
  end

  def ssh2_privkey_decode2(<<7 :: size(32) - unsigned - big - integer, "ssh-rsa",
             _NL :: size(32) - unsigned - big - integer,
             n :: size(_NL) - big - signed - integer - unit(8),
             _EL :: size(32) - unsigned - big - integer,
             e :: size(_EL) - big - signed - integer - unit(8),
             _DL :: size(32) - unsigned - big - integer,
             d :: size(_DL) - big - signed - integer - unit(8),
             _IQMPL :: size(32) - unsigned - big - integer,
             iQMP :: size(_IQMPL) - big - signed - integer - unit(8),
             _PL :: size(32) - unsigned - big - integer,
             p :: size(_PL) - big - signed - integer - unit(8),
             _QL :: size(32) - unsigned - big - integer,
             q :: size(_QL) - big - signed - integer - unit(8),
             rest :: binary>>) do
    {r_RSAPrivateKey(version: :"two-prime", modulus: n, publicExponent: e,
         privateExponent: d, prime1: p, prime2: q,
         coefficient: iQMP),
       rest}
  end

  def ssh2_privkey_decode2(<<7 :: size(32) - unsigned - big - integer, "ssh-dss",
             _PL :: size(32) - unsigned - big - integer,
             p :: size(_PL) - big - signed - integer - unit(8),
             _QL :: size(32) - unsigned - big - integer,
             q :: size(_QL) - big - signed - integer - unit(8),
             ...
             _YL :: size(32) - unsigned - big - integer,
             y :: size(_YL) - big - signed - integer - unit(8),
             _XL :: size(32) - unsigned - big - integer,
             x :: size(_XL) - big - signed - integer - unit(8),
             rest :: binary>>) do
    {r_DSAPrivateKey(version: 0, p: p, q: q, g: g, y: y, x: x), rest}
  end

  def ssh2_privkey_decode2(<<sCNL :: size(32) - unsigned - big - integer,
             sshCurveName :: size(sCNL) - binary,
             rest0 :: binary>>) do
    {pub, priv, rest} = (case ({sshCurveName, rest0}) do
                           {<<"ecdsa-sha2-", _ :: binary>>,
                              <<_IL :: size(32) - unsigned - big - integer,
                                  _Curve :: size(_IL) - binary,
                                  _QL :: size(32) - unsigned - big - integer,
                                  pub1 :: size(_QL) - binary,
                                  _PrivL :: size(32) - unsigned - big - integer,
                                  priv1 :: size(_PrivL) - binary,
                                  rest1 :: binary>>} ->
                             {pub1, priv1, rest1}
                           {<<"ssh-ed", _ :: binary>>,
                              <<pL :: size(32) - unsigned - big - integer,
                                  pub1 :: size(pL) - binary,
                                  pPL :: size(32) - unsigned - big - integer,
                                  privPub :: size(pPL) - binary,
                                  rest1 :: binary>>} ->
                             ^pL = div(pPL, 2)
                             <<priv1 :: size(pL) - binary,
                                 _ :: binary>> = privPub
                             {pub1, priv1, rest1}
                         end)
    oID = ssh_curvename2oid(sshCurveName)
    {r_ECPrivateKey(version: 1, parameters: {:namedCurve, oID},
         privateKey: priv, publicKey: pub),
       rest}
  end

  def ssh_curvename2oid("ssh-ed25519") do
    {1, 3, 101, 112}
  end

  def ssh_curvename2oid("ssh-ed448") do
    {1, 3, 101, 113}
  end

  def ssh_curvename2oid("ecdsa-sha2-nistp256") do
    {1, 2, 840, 10045, 3, 1, 7}
  end

  def ssh_curvename2oid("ecdsa-sha2-nistp384") do
    {1, 3, 132, 0, 34}
  end

  def ssh_curvename2oid("ecdsa-sha2-nistp521") do
    {1, 3, 132, 0, 35}
  end

  def oid2ssh_curvename({1, 3, 101, 112}) do
    {"ssh-ed25519", :"n/a"}
  end

  def oid2ssh_curvename({1, 3, 101, 113}) do
    {"ssh-ed448", :"n/a"}
  end

  def oid2ssh_curvename({1, 2, 840, 10045, 3, 1, 7}) do
    {"ecdsa-sha2-nistp256", "nistp256"}
  end

  def oid2ssh_curvename({1, 3, 132, 0, 34}) do
    {"ecdsa-sha2-nistp384", "nistp384"}
  end

  def oid2ssh_curvename({1, 3, 132, 0, 35}) do
  ...
  def decode_keyboard_interactive_prompts(<<__0 :: size(32) - unsigned - big - integer,
             prompt :: size(__0) - binary,
             bool :: size(8) - unsigned - big - integer,
             bin :: binary>>,
           acc) do
    decode_keyboard_interactive_prompts(bin,
  ...
  defp decode_kex_init(<<bool :: size(8) - unsigned - big - integer,
              x :: size(32) - unsigned - big - integer>>,
            acc, 0) do
    :erlang.list_to_tuple(:lists.reverse([x,
                                              erl_boolean(bool) | acc]))
  end
  ...
  defp decode_kex_init(<<__0 :: size(32) - unsigned - big - integer,
              data :: size(__0) - binary, rest :: binary>>,
            acc, n) do
    names = :string.tokens(ucl(data), ',')
    decode_kex_init(rest, [names | acc], n - 1)
  end

  defp decode_signature(<<__0 :: size(32) - unsigned - big - integer,
              alg :: size(__0) - binary,
  ...
  defp encode_signature({r_ECPoint(), {:namedCurve, oID}}, _SigAlg,
            signature) do
    {sshCurveName, _} = oid2ssh_curvename(oID)
    <<byte_size(<<sshCurveName :: binary>>)
      ::
      size(32) - unsigned - big - integer,
        <<sshCurveName :: binary>> :: binary,
        byte_size(signature)
        ::
        size(32) - unsigned - big - integer,
        signature :: binary>>
  ...
  def ssh_dbg_on(p) when p == :ssh_messages or
                   p == :raw_messages do
    :dbg.tp(:ssh_message, :encode, 1, :x)
    :dbg.tp(:ssh_message, :decode, 1, :x)
  end

  def ssh_dbg_off(p) when p == :ssh_messages or
                   p == :raw_messages do
    :dbg.ctpg(:ssh_message, :encode, 1)
    :dbg.ctpg(:ssh_message, :decode, 1)
  end

  def ssh_dbg_format(:ssh_messages,
           {:call, {:ssh_message, :encode, [msg]}}) do
    name = :string.to_upper(:erlang.atom_to_list(:erlang.element(1,
                                                                   msg)))
    ['Going to send ', name, ':\n', wr_record(:ssh_dbg.shrink_bin(msg))]
  end

  def ssh_dbg_format(:ssh_messages,
           {:return_from, {:ssh_message, :encode, 1}, _Ret}) do
    :skip
  end

  def ssh_dbg_format(:ssh_messages,
           {:call, {:ssh_message, :decode, [_]}}) do
    :skip
  end

  def ssh_dbg_format(:ssh_messages,
           {:return_from, {:ssh_message, :decode, 1}, msg}) do
    name = :string.to_upper(:erlang.atom_to_list(:erlang.element(1,
                                                                   msg)))
    ['Received ', name, ':\n', wr_record(:ssh_dbg.shrink_bin(msg)),
                     case (msg) do
                       r_ssh_msg_userauth_request(service: 'ssh-connection', method: 'publickey',
                           data: <<_,
                                     __0 :: size(32) - unsigned - big - integer,
                                     alg :: size(__0) - binary,
                                     _ :: binary>>) ->
                         :io_lib.format('  data decoded: ~s ... ~n', [alg])
                       r_ssh_msg_channel_request(request_type: 'env',
                           data: <<__0 :: size(32) - unsigned - big - integer,
                                     var :: size(__0) - binary,
                                     __1 :: size(32) - unsigned - big - integer,
                                     val :: size(__1) - binary>>) ->
                         :io_lib.format('  data decoded: ~s = ~s~n', [var, val])
                       r_ssh_msg_channel_request(request_type: 'exec',
                           data: <<__0 :: size(32) - unsigned - big - integer,
                                     cmnd :: size(__0) - binary>>) ->
                         :io_lib.format('  data decoded: ~s~n', [cmnd])
                       r_ssh_msg_channel_request(request_type: 'pty-req',
                           data: <<_TermLen
                                   ::
                                   size(32) - unsigned - big - integer,
                                     bTermName :: size(_TermLen) - binary,
                                     width
                                     ::
                                     size(32) - unsigned - big - integer,
                                     height
                                     ...
                                     size(32) - unsigned - big - integer,
                                     modes :: binary>>) ->
                         :io_lib.format('  data decoded: terminal = ~s~n                width x height = ~p x ~p~n                pix-width x pix-height = ~p x ~p~n                pty-opts = ~p~n',
                                          [bTermName, width, height, pixWidth,
                                                                         pixHeight,
  ...
  def ssh_dbg_format(:raw_messages,
           {:call, {:ssh_message, :decode, [bytesPT]}}) do
    ['Received plain text bytes (shown after decryption):\n', :io_lib.format('~p', [bytesPT])]
  end

  def ssh_dbg_format(:raw_messages,
           {:return_from, {:ssh_message, :decode, 1}, _Ret}) do
    :skip
  end

  def ssh_dbg_format(:raw_messages,
           {:call, {:ssh_message, :encode, [_]}}) do
    :skip
  end

  def ssh_dbg_format(:raw_messages,
           {:return_from, {:ssh_message, :encode, 1}, bytesPT}) do
  ...
  defp wr_record(r = r_ssh_msg_service_request()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_service_request(r_ssh_msg_service_request())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_kex_dh_gex_request()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_kex_dh_gex_request(r_ssh_msg_kex_dh_gex_request())), [])
  end

  defp wr_record(r = r_ssh_msg_kex_dh_gex_request_old()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_kex_dh_gex_request_old(r_ssh_msg_kex_dh_gex_request_old())), [])
  end

  defp wr_record(r = r_ssh_msg_kex_dh_gex_group()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_kex_dh_gex_group(r_ssh_msg_kex_dh_gex_group())), [])
  end

  defp wr_record(r = r_ssh_msg_kex_dh_gex_init()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_kex_dh_gex_init(r_ssh_msg_kex_dh_gex_init())), [])
  end

  defp wr_record(r = r_ssh_msg_kex_dh_gex_reply()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_kex_dh_gex_reply(r_ssh_msg_kex_dh_gex_reply())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_userauth_request()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_request(r_ssh_msg_userauth_request())), [])
  end

  defp wr_record(r = r_ssh_msg_userauth_failure()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_failure(r_ssh_msg_userauth_failure())), [])
  end

  defp wr_record(r = r_ssh_msg_userauth_success()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_success(r_ssh_msg_userauth_success())), [])
  end

  defp wr_record(r = r_ssh_msg_userauth_banner()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_banner(r_ssh_msg_userauth_banner())), [])
  end

  defp wr_record(r = r_ssh_msg_userauth_passwd_changereq()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_passwd_changereq(r_ssh_msg_userauth_passwd_changereq())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_userauth_info_request()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_info_request(r_ssh_msg_userauth_info_request())), [])
  end

  defp wr_record(r = r_ssh_msg_userauth_info_response()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_userauth_info_response(r_ssh_msg_userauth_info_response())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_request_success()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_request_success(r_ssh_msg_request_success())), [])
  end

  defp wr_record(r = r_ssh_msg_request_failure()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_request_failure(r_ssh_msg_request_failure())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_channel_open_confirmation()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_open_confirmation(r_ssh_msg_channel_open_confirmation())), [])
  end

  defp wr_record(r = r_ssh_msg_channel_open_failure()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_open_failure(r_ssh_msg_channel_open_failure())), [])
  end

  defp wr_record(r = r_ssh_msg_channel_window_adjust()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_window_adjust(r_ssh_msg_channel_window_adjust())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_channel_extended_data()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_extended_data(r_ssh_msg_channel_extended_data())), [])
  end
  ...
  defp wr_record(r = r_ssh_msg_channel_request()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_request(r_ssh_msg_channel_request())), [])
  end

  defp wr_record(r = r_ssh_msg_channel_success()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_success(r_ssh_msg_channel_success())), [])
  end

  defp wr_record(r = r_ssh_msg_channel_failure()) do
    :ssh_dbg.wr_record(r, Keyword.keys(r_ssh_msg_channel_failure(r_ssh_msg_channel_failure())), [])
  end
