defmodule :m_ssh_bits do
  ...
  def mpint(i) when i > 0 do
    ...
    case b1 &&& 128 do
      128 ->
        <<byte_size(v) + 2::size(32)-unsigned-big-integer, 0, b1, v::binary>>

      _ ->
        <<byte_size(v) + 1::size(32)-unsigned-big-integer, b1, v::binary>>
    end
  end
  ...
  def mpint(n) when n < 0 do
    ...
    case b1 &&& 128 do
      ...
      _ ->
        <<byte_size(v) + 2::size(32)-unsigned-big-integer, 255, b1, v::binary>>
    end
  end
