      ...
      {:ok, sock} ->
        ...
        data =
          case connectToAddr do
            :undefined ->
              <<byte_size(listenAddrStr)::size(32)-unsigned-big-integer, listenAddrStr::binary,
                listenPort::size(32)-unsigned-big-integer,
                byte_size(remHostBin)::size(32)-unsigned-big-integer, remHostBin::binary,
                remPort::size(32)-unsigned-big-integer>>

            {connectToHost, connectToPort} ->
              <<byte_size(connectToHost)::size(32)-unsigned-big-integer, connectToHost::binary,
