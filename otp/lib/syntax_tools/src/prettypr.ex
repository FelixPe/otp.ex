    ...
    case (c) do
            ...
            case (is_empty_string(s)) do
              ...
              true ->
                case (r_c_sep_nest(c1, :p)) do
                  false ->
                    rewrite(expand_sep(above(__MODULE__.nil(),
                                               nest(n1, d1)),
                                         ds, n),
                              c2)
                  true ->
                    rewrite(expand_par(above(__MODULE__.nil(),
                                               nest(n1, d1)),
                                         ds, n),
                              c2)
                end
          ...
          r_c_above_nest(d: d2, i: n, c: c2) ->
            case (is_empty_string(s)) do
              false ->
                w = width(s)
                rewrite(beside(mktext(s),
                                 above(beside(__MODULE__.nil(), d1),
                                         nest(n - w, d2))),
                          c2)
              true ->
          ...
          r_c_sep_nest(ds: ds, i: n, c: c2) ->
            case (is_empty_string(s)) do
              false ->
                w = width(s)
                rewrite(beside(mktext(s),
                                 mksep([beside(__MODULE__.nil(), d1) | ds],
                                         n - w, r_c_sep_nest(c1, :p))),
                          c2)
              true ->
                rewrite(d1, r_c_text_beside(s: s, c: c1))
      ...
      r_c_sep_nest(ds: ds, i: n, c: c1) ->
        case (is_empty_string(s)) do
          false ->
            rewrite(beside(mktext(s),
                             mksep([__MODULE__.nil() | ds], n - width(s),
                                     r_c_sep_nest(c, :p))),
                      c1)
          true ->
