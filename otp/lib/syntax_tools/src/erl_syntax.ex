defmodule :m_erl_syntax do
  ...
  Record.defrecord(:r_maybe_match_expr, :maybe_match_expr,
    pattern: :undefined,
    body: :undefined
  )
  ...
  Record.defrecord(:r_map_comp, :map_comp,
    template: :undefined,
    body: :undefined
  )
  ...
  Record.defrecord(:r_map_generator, :map_generator,
    pattern: :undefined,
    body: :undefined
  )
  ...
  Record.defrecord(:r_maybe_expr, :maybe_expr,
    body: :undefined,
    else: :none
  )
    ...
    case is_leaf(t) do
      ...
      false ->
        case type(t) do
          ...
          :maybe_match_expr ->
            [[maybe_match_expr_pattern(t)], [maybe_match_expr_body(t)]]
