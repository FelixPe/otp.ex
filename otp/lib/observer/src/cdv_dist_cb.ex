defmodule :m_cdv_dist_cb do
  ...
  def col_spec() do
    [{'Name', 0, 300}, {'Connection type', 0, 130}, {'Controller', 0, 130}, {'Channel', 1, 80}, {'Creation',
                                                           1, 80}]
  end
  ...
  def get_details(id, _) do
    case (:crashdump_viewer.node_info(id)) do
      {:ok, info, tW} ->
        proplist = :crashdump_viewer.to_proplist(Keyword.keys(r_nod(r_nod())),
                                                   info)
  ...
  defp info_fields() do
    [{'Overview',
        [{'Name', :name}, {'Type', :conn_type}, {'Channel', :channel}, {'Controller',
                                                        {:click, :controller}},
                                                         {'Creation',
                                                            {{:format,
                                                                &format/1},
                                                             ...
                                                             {'Extra Info', :error}]},
         {:scroll_boxes,
            [{'Remote Links', 1, {:click, :remote_links}}, {'Remote Monitors', 1,
                                                 {:click, :remote_mon}},
                                                  {'Remote Monitored By', 1,
                                                     {:click,
                                                        :remote_mon_by}}]}]
  end
