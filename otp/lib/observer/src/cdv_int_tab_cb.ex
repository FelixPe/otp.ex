defmodule :m_cdv_int_tab_cb do
  ...
  def get_info() do
    ...
    [{'Hash Tables', :cdv_table_wx, hashInfo}, {'Index Tables', :cdv_table_wx,
                                      indexInfo},
  ...
  defp hash_columns() do
    [{'Name', 0, 150}, {'Size', 1, 100}, {'Used', 1, 100}, {'Objects', 1, 100}, {'Depth',
                                                            1, 100}]
  end
  ...
  defp index_columns() do
    [{'Name', 0, 150}, {'Size', 1, 100}, {'Limit', 1, 100}, {'Used', 1, 100}, {'Rate',
                                                            1, 100},
                                                             {'Entries', 1, 100}]
  end
  ...
  defp get_internal_ets_info() do
    {:ok, info0,
       tW} = :crashdump_viewer.internal_ets_tables()
    columns = int_ets_columns()
    info = (for {desc, r} <- info0 do
              (
  ...
  defp int_ets_columns() do
    [{'Description', 0, 170}, {'Id', 0, 80}, {'Name', 0, 80}, {'Type', 0, 80}, {'Buckets', 1,
                                                         80},
                                                          {'Objects', 1, 80}, {'Memory', 1,
                                                                         80}]
  end
