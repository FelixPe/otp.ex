defmodule :m_cdv_mod_cb do
  ...
  def get_details(id, _) do
    {:ok, info,
       tW} = :crashdump_viewer.loaded_mod_details(id)
    proplist = :crashdump_viewer.to_proplist(Keyword.keys(r_loaded_mod(r_loaded_mod())),
                                               info)
  ...
  def detail_pages() do
    [{'General Information', &init_gen_page/2}, {'Current Attributes', &init_curr_attr_page/2}, {'Current Compilation Info',
                                                            &init_curr_comp_page/2},
                                                             {'Old Attributes',
                                                                &init_old_attr_page/2},
                                                                 {'Old Compilation Info',
                                                                    &init_old_comp_page/2}]
  end
