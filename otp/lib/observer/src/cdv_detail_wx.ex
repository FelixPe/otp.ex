defmodule :m_cdv_detail_wx do
  ...
  defp display_progress(parentFrame, :cdv) do
    :observer_lib.display_progress_dialog(parentFrame, ~c"Crashdump Viewer", ~c"Reading data")
  end
  ...
  defp display_progress_pulse(:cdv_proc_cb, pid) do
    :observer_lib.report_progress({:ok, ~c"Displaying data for " ++ pid})
  ...
  defp create_menus(menuBar) do
    menus = [{~c"File", [r_create_menu(id: 5001, text: ~c"Close")]}]
