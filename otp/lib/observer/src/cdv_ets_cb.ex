defmodule :m_cdv_ets_cb do
  ...
  def col_spec() do
    [{'Name', 0, 200}, {'Is Named', 2, 70}, {'Owner', 2, 120}, {'Objects', 1, 80}, {'Memory',
                                                          1, 80}]
  end
  ...
  def get_details(id, data) do
    proplist = :crashdump_viewer.to_proplist(Keyword.keys(r_ets_table(r_ets_table())),
                                               data)
  ...
  defp info_fields() do
    [{'Overview',
        [{'Id', :id}, {'Name', :name}, {'Slot', :slot}, {'Owner', :pid}, {'Data Structure',
                                                         :data_type}]},
         {'Settings',
            [{'Type', :type}, {'Protection', :protection}, {'Compressed', :compressed}, {'Fixed',
                                                                :fixed},
                                                                 {'Lock write concurrency', :write_c},
                                                                     {'Lock read concurrency',
                                                                        :read_c}]},
             {'Memory Usage',
                [{'Buckets', :buckets}, {'Size', :size}, {'Memory', :memory}, {'Min Chain Length',
                                                             :chain_min},
