defmodule :m_dbg_wx_code do
  ...
  def code_area(parent) do
    ...
    :wxStyledTextCtrl.cmdKeyClearAll(ed)
    :wxStyledTextCtrl.cmdKeyAssign(ed, 300, 0, 2300)
    :wxStyledTextCtrl.cmdKeyAssign(ed, 301, 0, 2302)
    ed
  end
  ...
  def find(ed, str, case__, next) do
    ...
    case (res >= 0) do
      true ->
        :wxStyledTextCtrl.scrollToLine(ed,
                                         :wxStyledTextCtrl.lineFromPosition(ed,
                                                                              res) - 3)
        true
      false ->
        false
