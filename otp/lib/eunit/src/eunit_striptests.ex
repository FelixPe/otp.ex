defmodule :m_eunit_striptests do
  ...
  def parse_transform(forms, options) do
    testSuffix = :proplists.get_value(:eunit_test_suffix, options, ~c"_test")
    generatorSuffix = :proplists.get_value(:eunit_generator_suffix, options, ~c"_test_")
    exportSuffix = :proplists.get_value(:eunit_export_suffix, options, ~c"_exported_")
