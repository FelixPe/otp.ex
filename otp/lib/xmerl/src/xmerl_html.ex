defmodule :m_xmerl_html do
  use Bitwise
  import :xmerl_lib, only: [end_tag: 1, export_text: 1,
                              find_attribute: 2, is_empty_data: 1, start_tag: 2]
  require Record
  ...
  def unquote(:"#root#")(data, attrs, [], _E) do
    ver = (case (find_attribute(:version, attrs)) do
             {:value, v} ->
               v
             false ->
               '-//W3C//DTD HTML 4.01 Transitional//EN'
           end)
    uRI = (case (find_attribute(:uri, attrs)) do
             {:value, u} ->
               [' "', u, '"']
             false ->
               ''
