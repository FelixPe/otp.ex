defmodule :m_xmerl_scan do
  ...
  defp int_string(str, options, xMLBase, fileName) do
    ...
    case :xmerl_lib.detect_charset(
      ...
      {:auto, :"iso-10646-utf-1", str2} ->
        scan_document(str2, r_xmerl_scanner(s, encoding: ~c"iso-10646-utf-1"))
  ...
  defp int_string_decl(str, options, xMLBase, fileName) do
    ...
    case :xmerl_lib.detect_charset(
      ...
      {:auto, :"iso-10646-utf-1", str2} ->
        scan_decl(str2, r_xmerl_scanner(s, encoding: ~c"iso-10646-utf-1"))
  ...
  defp initial_state([{:allow_entities, f} | t], s)
       when f == true or
              f == false do
  ...
  defp common_data() do
    {comdata(:lists.duplicate(60, ?\s), []), comdata(:lists.duplicate(15, ?\t), []), ~c"\n"}
  end
  ...
  defp scan_document(
    ...
    t2 = scan_mandatory(~c"<", t1, 1, s2, :expected_element_start_tag)
        ...
        true ->
          cond do
            ...
            true ->
              :error_logger.error_msg(
                ~c"~p- fatal: ~p~n",
                [695, {:xml_declaration_must_be_first_in_doc, col, l}]
              )
  ...
  defp scan_prolog(str = ~c"%" ++ _T, s = r_xmerl_scanner(environment: {:external, _}), pos, acc) do
  ...
  defp scan_prolog2(~c"<!DOCTYPE" ++ t, s0 = r_xmerl_scanner(environment: :prolog), pos, acc) do
    :no_debug
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 9)
  ...
  defp scan_prolog2(str = ~c"<!" ++ _, s, pos, acc) do
    :no_debug
    {t, s1} = scan_ext_subset(str, s)
    {acc, pos, t, s1}
  end
  ...
  defp scan_misc(~c"<!--" ++ t, s0 = r_xmerl_scanner(acc_fun: f, comments: cF), pos, acc) do
    :no_debug
  ...
  defp scan_misc(~c"<?" ++ t, s0 = r_xmerl_scanner(acc_fun: f), pos, acc) do
    :no_debug
    :no_debug
        ...
        _ ->
          cond do
            ...
            true ->
              :error_logger.error_msg(
                ~c"~p- fatal: ~p~n",
                [856, :expected_version_attribute]
              )
  ...
  defp scan_xml_decl(~c"?>" ++ t, s0, decl) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 2)
  ...
  defp scan_xml_decl(_T, s = r_xmerl_scanner(event_fun: _Event), _Decl) do
    ...
    fatal(
      preformat([:expected, :one, :"of:"], [:"?>", :whitespace_character], ~c","),
      s
    )
  end

  defp scan_xml_decl2(~c"?>" ++ t, s0, decl) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 2)
    return_xml_decl(t, s, decl)
  end
  ...
  defp scan_xml_decl2(t = ~c"standalone" ++ _T, s, decl) do
  ...
  defp scan_xml_decl2(_BadString, s, _Decl) do
    ...
    fatal(
      preformat([:expected, :one, :"of:"], [:"?>", :standalone, :encoding], ~c","),
      s
    )
  end

  defp scan_xml_decl3(~c"?>" ++ t, s0, decl) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 2)
    return_xml_decl(t, s, decl)
  end
  ...
  defp scan_xml_decl3(
    ...
    {_, t3, s4} = strip(t2, s3)
    t4 = scan_mandatory(~c"?>", t3, 2, s4, :expected_xml_decl_endtag)
  ...
  defp scan_standalone_value(~c"'yes'" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 5)
  ...
  defp scan_standalone_value(~c"'no'" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 4)
    {:no, t, s}
  end
  ...
  defp scan_text_decl([h | _T], s, _) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1005, {:unexpected_character_in_text_declaration, h}]
        )
  ...
  defp scan_optional_version(~c"version" ++ t, s0) do
    :no_debug
  ...
  defp scan_enc_name([h | _T], s, _Delim, _Acc) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1043, {:error, {:unexpected_character_in_Enc_Name, h}}]
        )
  ...
  defp scan_wellknown_pi(~c"-stylesheet" ++ t, s0 = r_xmerl_scanner(line: l, col: c), pos, ps) do
    :no_debug
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 16)
    scan_pi(t, s, ~c"xml-stylesheet", l, c, pos, ps, [])
  end
  ...
  defp scan_wellknown_pi(str, s, _Pos, _Ps) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1130, {:invalid_target_name, :lists.sublist(str, 1, 10)}]
        )
  ...
  defp scan_pi([h | _T], s, _Target, _L, _C, _Pos, _Ps, _Acc) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1159, {:expected_whitespace_OR_end_of_PI, {:char, h}}]
        )
  ...
  defp scan_doctype1(~c"PUBLIC" ++ t, s0) do
    :no_debug
  ...
  defp scan_doctype1(~c"SYSTEM" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = mandatory_strip(t, s)
  ...
  defp scan_doctype2(~c"[" ++ t, s0, dTD) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {_, t1, s1} = strip(t, s)
  ...
  defp scan_doctype3(~c"%" ++ t, s0, dTD) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_doctype3(~c"]" ++ t, s0, dTD) do
    ...
    s2 = fetch_DTD(dTD, s1)
    check_decl(s2)
    t2 = scan_mandatory(~c">", t1, 1, s2, :expected_doctype_end_tag)
    {t2, s2}
  end
        ...
        error ->
          cond do
            ...
            true ->
              :error_logger.error_msg(
                ~c"~p- fatal: ~p~n",
                [1358, {:error_fetching_DTD, {extSpec, error}}]
              )
      ...
      {:ok, :not_fetched, _NewS} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1371, {:error_fetching_external_source, extSpec}]
            )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1385, {:error_fetching_external_resource, extSpec}]
            )
      ...
      [l] when is_list(l) ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1412, {:error_missing_declaration_in_DTD, hd(l)}]
            )
      ...
      err ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1414, {:error_missing_declaration_in_DTD, err}]
            )
      ...
      err ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1433, {:error_missing_declaration_in_DTD, err}]
            )
      ...
      {:value, att2} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1446, {:error_more_than_one_ID_def, n1, :erlang.element(1, att2)}]
            )
      ...
      [l] when is_list(l) ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1469, {:error_missing_declaration_in_DTD, hd(l)}]
            )
      ...
      err ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1471, {:error_missing_declaration_in_DTD, err}]
            )
      ...
      [l] when is_list(l) ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1487, {:error_missing_declaration_in_DTD, hd(l)}]
            )
      ...
      err ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [1489, {:error_missing_declaration_in_DTD, err}]
            )
  ...
  defp scan_ext_subset(~c"%" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_conditional_sect(~c"IGNORE" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = strip(t, s)
    t2 = scan_mandatory(~c"[", t1, 1, s, :expected_IGNORE_bracket)
    {_, t3, s3} = strip(t2, s1)
    scan_ignore(t3, s3)
  end

  defp scan_conditional_sect(~c"INCLUDE" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 7)
    {_, t1, s1} = strip(t, s)
    t2 = scan_mandatory(~c"[", t1, 1, s, :expected_INCLUDE_bracket)
    {_, t3, s3} = strip(t2, s1)
    scan_include(t3, s3)
  end

  defp scan_conditional_sect(~c"%" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {pERefName, t1, s1} = scan_pe_reference(t, s)
  ...
  defp scan_ignore(~c"<![" ++ t, s0, level) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
    scan_ignore(t, s, level + 1)
  end

  defp scan_ignore(~c"]]>" ++ t, s0, 0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
    {[], t, s}
  end
  ...
  defp scan_markup_decl(~c"<!--" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 4)
    scan_comment(t, s)
  end
  ...
  defp scan_markup_decl(
    ...
    {_, t5, s5} = strip(t4, s4)
    {~c">" ++ t6, s6} = scan_element_completion(t5, s5)
  ...
  defp scan_markup_decl(~c"<!ENTITY" ++ t, s0) do
  ...
  defp scan_markup_decl(~c"<!NOTATION" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 10)
    {_, t1, s1} = mandatory_strip(t, s)
  ...
  defp scan_markup_decl(_Str, s) do
    cond do
      ...
      true ->
        :error_logger.error_msg(~c"~p- fatal: ~p~n", [1739, :expected_markup])
        :ok
    end
  ...
  defp scan_attdef(~c">" ++ t, s0, attrs) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {:lists.reverse(attrs), t, s}
  end

  defp scan_attdef(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog), _Attrs) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1779, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_attdef2(~c">" ++ t, s0, attrs) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {:lists.reverse(attrs), t, s}
  end

  defp scan_attdef2(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog), _Attrs) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1794, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_att_type(~c"CDATA" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 5)
    {:CDATA, t, s}
  end

  defp scan_att_type(~c"IDREFS" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {:IDREFS, t, s}
  end

  defp scan_att_type(~c"IDREF" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 5)
    {:IDREF, t, s}
  end

  defp scan_att_type(~c"ID" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 2)
    {:ID, t, s}
  end

  defp scan_att_type(~c"ENTITY" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {:ENTITY, t, s}
  end

  defp scan_att_type(~c"ENTITIES" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 8)
    {:ENTITIES, t, s}
  end

  defp scan_att_type(~c"NMTOKENS" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 8)
    {:NMTOKENS, t, s}
  end

  defp scan_att_type(~c"NMTOKEN" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 7)
    {:NMTOKEN, t, s}
  end

  defp scan_att_type(~c"NOTATION" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 8)
    {_, t1, s1} = mandatory_strip(t, s)
    t2 = scan_mandatory(~c"(", t1, 1, s1, :expected_parenthesis_after_NOTATION)
    s2 = s1
    {_, t3, s3} = strip(t2, s2)
  ...
  defp scan_att_type(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog)) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [1863, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_notation_type(~c")" ++ t, s0, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_enumeration(~c")" ++ t, s0, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_default_decl(~c"#REQUIRED" ++ t, s0, _Type) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 9)
    {{:"#REQUIRED", :no_value}, t, s}
  end

  defp scan_default_decl(~c"#IMPLIED" ++ t, s0, _Type) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 8)
    {{:"#IMPLIED", :no_value}, t, s}
  end

  defp scan_default_decl(~c"#FIXED" ++ t, s0, type) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = mandatory_strip(t, s)
  ...
  defp scan_entity(~c"%" ++ t, r_xmerl_scanner(rules_write_fun: write) = s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {_, t1, s1} = mandatory_strip(t, s)
    ...
    {_, t5, s5} = strip(t4, s4)
    {~c">" ++ t6, s6} = scan_entity_completion(t5, s5)
  ...
  defp scan_entity(
    ...
    {_, t4, s4} = strip(t3, s3)
    {~c">" ++ t5, s5} = scan_entity_completion(t4, s4)
  ...
  defp scan_entity_def(~c"'" ++ t, s0, eName) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_ndata_decl(str = ~c">" ++ _T, s) do
    {[], str, s}
  end
  ...
  defp scan_ndata_decl2(str = ~c">" ++ _T, s) do
    {[], str, s}
  end
  ...
  defp scan_element(
    ...
    xMLSpace =
      case :lists.keysearch(:"xml:space", r_xmlAttribute(:name), attrs1) do
        ...
        {:value, r_xmlAttribute(value: ~c"default")} ->
          spaceOption

        {:value, r_xmlAttribute(value: ~c"preserve")} ->
          :preserve
  ...
  defp resolve_relative_uri(newBase = ~c"/" ++ _, currentBase) do
    case :xmerl_uri.parse(currentBase) do
      {:error, _Reason} ->
        newBase

      {scheme, host, port, _Path, _Query} ->
        :erlang.atom_to_list(scheme) ++ host ++ ~c":" ++ :erlang.integer_to_list(port) ++ newBase
    end
  end
  ...
  defp check_namespace(_, {~c"xmlns", prefix}, value, nS = r_xmlNamespace(nodes: ns)) do
      ...
      :"http://www.w3.org/XML/1998/namespace" ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2316, :cannot_bind_default_namespace_to_xml_namespace_name]
            )
      ...
      :"http://www.w3.org/2000/xmlns/" ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2318, :cannot_bind_default_namespace_to_xmlns_namespace_name]
            )
  ...
  defp expanded_name(name, n = {~c"xmlns", local}, r_xmlNamespace(nodes: ns), s) do
      ...
      :"xmlns:xml" when value !== :"http://www.w3.org/XML/1998/namespace" ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2328, {:xml_prefix_cannot_be_redeclared, value}]
            )
      ...
      :"xmlns:xmlns" ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2330, {:xmlns_prefix_cannot_be_declared, value}]
            )
          ...
          :"http://www.w3.org/XML/1998/namespace" ->
            cond do
              ...
              true ->
                :error_logger.error_msg(
                  ~c"~p- fatal: ~p~n",
                  [2334, {:cannot_bind_prefix_to_xml_namespace, local}]
                )
          ...
          :"http://www.w3.org/2000/xmlns/" ->
            cond do
              ...
              true ->
                :error_logger.error_msg(
                  ~c"~p- fatal: ~p~n",
                  [2336, {:cannot_bind_prefix_to_xmlns_namespace, local}]
                )
  ...
  defp expanded_name(_Name, {~c"xml", local}, _NS, _S) do
      ...
      false ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2350, {:namespace_prefix_not_declared, prefix}]
            )
  ...
  defp scan_att_value(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog), _AttType) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [2369, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_att_chars(~c"&" ++ t, s0, delim, acc, tmpAcc, aT, isNorm) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_att_chars(~c"<" ++ _T, s0, _Delim, _Acc, _, _, _) do
    cond do
      r_xmerl_scanner(s0, :quiet) ->
        :ok

      true ->
        :error_logger.error_msg(~c"~p- fatal: ~p~n", [2445, :unexpected_char])
        :ok
    end
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2481, {:illegal_first_character, ent, name}]
            )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2489, {:illegal_first_character, iDR, name}]
            )
      ...
      false ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2498, {:ID_names_must_be_Name_production, name}]
            )
      ...
      ^sName ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2509, {:values_must_be_unique, :ID, sName}]
            )
  ...
  defp scan_content(
    ...
    f.(
      fn moreBytes, s1 ->
        scan_content(~c"<" ++ moreBytes, s1, pos, name, attrs, space, lang, parents, nS, acc, [])
      end,
      fatal_fun(:unexpected_end),
      s
    )
  ...
  defp scan_content(~c"</" ++ t, s0, _Pos, name, _Attrs, _Space, _Lang, _Parents, _NS, acc, []) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 2)
      ...
      true ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2570, {:endtag_does_not_match, {:was, eTagName, :should_have_been, name}}]
            )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2577, {:error, {:unexpected_end_of_STag}}]
            )
  ...
  defp scan_content(~c"&" ++ t, s0, pos, name, attrs, space, lang, parents, nS, acc, []) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {expRef, t1, s1} = scan_reference(t, s)
  ...
  defp scan_content_markup(~c"![CDATA[" ++ t, s0, pos, _Name, _Attrs, _Space, _Lang, parents, _NS) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 8)
    scan_cdata(t, s, pos, parents)
  end

  defp scan_content_markup(~c"?" ++ t, s0, pos, _Name, _Attrs, _Space, _Lang, parents, _NS) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_char_data([?& | t], s, space, ~c"&", acc) do
  ...
  defp scan_char_data(~c"]]>" ++ _T, s, _Space, _MUD, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
  ...
  defp scan_char_data([h1, h2 | _T], s, _Space, _MUD, _Acc)
    ...
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [2726, {:error, {:not_allowed_to_use_Unicode_noncharacters}}]
        )
  ...
  defp scan_char_data(~c"]]>" ++ _T, s, _Space, _MUD, _Acc) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [2728, {:error, {:illegal_character_in_content, ~c"]]>"}}]
        )

        :ok
    end

    fatal({:error, {:illegal_character_in_content, ~c"]]>"}}, s)
  end
  ...
  defp scan_cdata(~c"]]>" ++ t, s0, pos, parents, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
  ...
  defp scan_reference(~c"#x" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    ...
    cond do
      ...
      true ->
        cond do
          ...
          true ->
            :error_logger.error_msg(~c"~p- fatal: ~p~n", [2778, :invalid_char_ref])
            :ok
        end
    ...
    cond do
      ...
      true ->
        cond do
          ...
          true ->
            :error_logger.error_msg(~c"~p- fatal: ~p~n", [2786, :invalid_char_ref])
            :ok
        end
  ...
  defp scan_entity_ref(~c"amp;" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 4)
    {~c"&", t, s}
  end

  defp scan_entity_ref(~c"lt;" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
    {~c"<", t, s}
  end

  defp scan_entity_ref(~c"gt;" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
    {~c">", t, s}
  end

  defp scan_entity_ref(~c"apos;" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 5)
    {~c"'", t, s}
  end

  defp scan_entity_ref(~c"quot;" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 5)
    {~c"\"", t, s}
  end
  ...
  defp scan_entity_ref(t, s) do
    ...
    t2 = scan_mandatory(~c";", t1, 1, s1, :expected_entity_reference_semicolon)
    s2 = s1
  ...
  defp scan_pe_reference(t, s) do
    {name, _NamespaceInfo, t1, s1} = scan_name(t, s)
    t2 = scan_mandatory(~c";", t1, 1, s1, :expected_parsed_entity_reference_semicolon)
    ...
    case read.(:parameter_entity, name, s) do
      ...
      err = {:error, _Reason} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(~c"~p- fatal: ~p~n", [2851, err])
            :ok
        end
      ...
      {_, :external, {:error, :enoent}} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2883, {:error, {:entity_target_not_found, {:error, :enoent}, name}}]
            )
  ...
  defp scan_char_ref_dec(~c";" ++ t, s0, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_char_ref_hex(~c";" ++ t, s0, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    ...
    case t1 do
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(~c"~p- fatal: ~p~n", [2943, :assignment_expected])
            :ok
        end
      ...
      nSC == :no_colons ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2993, {:invalid_NCName, :lists.sublist(str, 1, 6)}]
            )
      ...
      true ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [2997, {:invalid_NCName, :lists.sublist(str, 1, 6)}]
            )
  ...
  defp scan_name(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog)) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3003, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_name(~c"%" ++ t, s0 = r_xmerl_scanner(environment: {:external, _})) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {pERefName, t1, s1} = scan_pe_reference(t, s)
    expRef = expand_pe_reference(pERefName, s1, :as_PE)
      ...
      false ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3018, {:invalid_name, :lists.sublist(str, 1, 6)}]
            )
  ...
  defp scan_name(str, s) do
    cond do
      ...
      true ->
        :error_logger.error_msg(~c"~p- fatal: ~p~n", [3021, {:invalid_name, str}])
        :ok
    end
  ...
  defp scan_nmtoken(~c"%" ++ t, s0 = r_xmerl_scanner(environment: {:external, _})) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {pERefName, t1, s1} = scan_pe_reference(t, s)
    expRef = expand_pe_reference(pERefName, s1, :as_PE)
      ...
      false ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3052, {:invalid_nmtoken, :lists.sublist(str, 1, 6)}]
            )
  ...
  defp scan_nmtoken(str = [?: | _], s, acc, [], _Local, :no_colons, _IsLatin1) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3071, {:invalid_NCName, :lists.sublist(:lists.reverse(acc) ++ str, 1, 6)}]
        )
  ...
  defp scan_nmtoken(str = [?: | _T], s, acc, _Prefix, _Local, _NSC = true, _IsLatin1) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3080, {:invalid_NCName, :lists.sublist(:lists.reverse(acc) ++ str, 1, 6)}]
        )
  ...
  defp scan_system_literal(~c"\"" ++ t, s) do
  ...
  defp scan_system_literal(~c"#" ++ _R, s, _H, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3131, :fragment_identifier_in_system_literal]
        )
  ...
  defp scan_contentspec(~c"EMPTY" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 5)
    {:empty, t, s}
  end

  defp scan_contentspec(~c"ANY" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
    {:any, t, s}
  end

  defp scan_contentspec(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog)) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3199, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_contentspec(~c"%" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {pERefName, t1, s1} = scan_pe_reference(t, s)
    expRef = expand_pe_reference(pERefName, s1, :as_PE)
  ...
  defp scan_elem_content(~c")" ++ t, s0, context, mode0, acc0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
      ...
      {other, :mixed, _} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3242, {:illegal_for_mixed_content, other}]
            )
  ...
  defp scan_elem_content(~c"#PCDATA" ++ _T, s, :not_mixed, _Mode, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
  ...
  defp scan_elem_content(~c"#PCDATA" ++ _T, s, _Cont, mode, acc)
    ...
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3252, {:error, {:invalid_format_of_mixed_content}}]
        )
  ...
  defp scan_elem_content(~c"#PCDATA" ++ t, s0, _Context, mode, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 7)
    {_, t1, s1} = strip(t, s)
  ...
  defp scan_elem_content(~c"," ++ _T, s, _Context, :choice, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3258, {:mixing_comma_and_vertical_bar_in_content_model}]
        )
  ...
  defp scan_elem_content(~c"," ++ t, s0, context, _Mode, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {_, t1, s1} = strip(t, s)
  ...
  defp scan_elem_content(~c"|" ++ _T, s, _Context, :seq, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3264, {:mixing_comma_and_vertical_bar_in_content_model}]
        )
  ...
  defp scan_elem_content2(~c"(" ++ _T, s, :mixed, _Mode, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3274, {:error, {:element_names_must_not_be_parenthesized_in_mixed_content}}]
        )
  ...
  defp scan_elem_content2(~c"(" ++ t, s0, context, mode, acc) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {_, t1, s1} = strip(t, s)
  ...
  defp scan_elem_content2(
    ...
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3281, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
      ...
      {other, :mixed} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3294, {:illegal_for_mixed_content, other}]
            )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3334, {:error, {:validity_constraint_Name_Token, c}}]
            )
  ...
  defp vc_ID_Attribute_Default({_, :ID, _, def__, _}, s) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3346, {:error, {:validity_constraint_error_ID_Attribute_Default, def__}}]
        )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3354, {:error, {:vc_enumeration, :erlang.list_to_atom(defaultVal), nameList}}]
            )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3364, {:error, {:vc_Entity_Name, :erlang.list_to_atom(defaultVal)}}]
            )
          ...
          true ->
            cond do
              ...
              true ->
                :error_logger.error_msg(
                  ~c"~p- fatal: ~p~n",
                  [3394, {:no_duplicate_types_allowed, h}]
                )
  ...
  defp mandatory_delimeter_wfc(~c"," ++ _T, _S) do
    :ok
  end
  ...
  defp mandatory_delimeter_wfc(t, s) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3417, {:comma_or_vertical_bar_mandatory_between_names_in_content_model, t}]
        )
      ...
      true ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3425, {:error, {:unique_att_spec_required, n}}]
            )
          ...
          true ->
            cond do
              ...
              true ->
                :error_logger.error_msg(
                  ~c"~p- fatal: ~p~n",
                  [3430, {:error, {:unique_att_spec_required, eN}}]
                )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3442, {:error, {:wfc_Legal_Character, ch}}]
            )
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3449, {:error, {:wfc_Legal_Character, ch}}]
            )
  ...
  defp wfc_whitespace_betw_attrs(_, s) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3465, {:whitespace_required_between_attributes}]
        )
  ...
  defp wfc_Entity_Declared({:external, _}, s = r_xmerl_scanner(standalone: :yes), name) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3468, {:reference_to_externally_defed_entity_standalone_doc, name}]
        )
  ...
  defp vc_Element_valid(_Name, {~c"xmlns", _}, s = r_xmerl_scanner(namespace_conformant: true)) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3484, {:error, {:illegal_element_prefix, :xmlns}}]
        )
      ...
      r_xmlElement(elementdef: :undeclared) ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3494, {:error, {:error_missing_element_declaration_in_DTD, name}}]
            )
      ...
      :undefined ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3495, {:error, {:error_missing_element_declaration_in_DTD, name}}]
            )
  ...
  defp scan_pe_def(~c"'" ++ t, s0, pEName) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
  ...
  defp scan_notation_decl(
    ...
    {_, t4, s4} = strip(t3, s3)
    t5 = scan_mandatory(~c">", t4, 1, s4, :expected_end_tag_notation_declaration)
  ...
  defp scan_notation_decl1(~c"SYSTEM" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = mandatory_strip(t, s)
    {sL, t2, s2} = scan_system_literal(t1, s1)
  ...
  defp scan_notation_decl1(~c"PUBLIC" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = mandatory_strip(t, s)
    {pIDL, t2, s2} = scan_pubid_literal(t1, s1)
  ...
  defp scan_external_id(~c"SYSTEM" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = mandatory_strip(t, s)
    {sL, t2, s2} = scan_system_literal(t1, s1)
  ...
  defp scan_external_id(~c"PUBLIC" ++ t, s0) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 6)
    {_, t1, s1} = mandatory_strip(t, s)
    {pIDL, t2, s2} = scan_pubid_literal(t1, s1)
  ...
  defp scan_entity_value(~c"%" ++ _T, s = r_xmerl_scanner(environment: :prolog), _, _, _, _, _) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3621, {:error, {:wfc_PEs_In_Internal_Subset}}]
        )
  ...
  defp scan_entity_value(~c"%" ++ t, s0, delim, acc, pEName, namespace, pENesting) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    {pERefName, t1, s1} = scan_pe_reference(t, s)
      ...
      pERefName == pEName and namespace == :parameter ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3631, {:illegal_recursion_in_PE, pEName}]
            )
    ...
    case t do
      ...
      _ ->
        ...
        scan_entity_value(
          ...
          s2,
          delim,
          [~c";", :erlang.atom_to_list(name), ~c"&" | acc],
          pEName,
          namespace,
          pENesting
        )
  ...
  defp scan_entity_value(~c"<![" ++ t, s0, delim, acc, pEName, :parameter = nS, pENesting) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 3)
    scan_entity_value(t, s, delim, [~c"<![" | acc], pEName, nS, pe_push(~c"<![", pENesting, s))
  end
  ...
  defp scan_entity_value(~c">" ++ t, s0, delim, acc, pEName, :parameter = nS, pENesting) do
    :no_debug
    s = r_xmerl_scanner(s0, col: r_xmerl_scanner(s0, :col) + 1)
    scan_entity_value(t, s, delim, [~c">" | acc], pEName, nS, pe_pop(~c">", pENesting, s))
  end
  ...
  defp pe_push(tok, stack, _S)
       when tok == ~c"<!" or tok == ~c"<?" or
              tok == ~c"<!--" or tok == ~c"<![" or tok == ~c"[" or tok == ~c"<" or
              tok == ~c"</" or tok == ~c"(" do
    [tok | stack]
  end

  defp pe_push(tok, stack, r_xmerl_scanner(validation: :dtd))
       when tok == ~c")" or tok == ~c">" or tok == ~c"?>" or tok == ~c"]]>" or
              tok == ~c"-->" or tok == ~c"/>" do
    [tok | stack]
  end
  ...
  defp pe_pop(token, _Stack, s = r_xmerl_scanner(validation: :dtd)) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3819, {:error, {:failed_VC_Proper_Declaration_PE_Nesting, 5, token}}]
        )
  ...
  defp pe_nesting_token(~c"<!" ++ _T, :parameter, :dtd) do
    ~c"<!"
  end
      ...
      {:EXIT, {:cyclic, _}} ->
        cond do
          ...
          true ->
            :error_logger.error_msg(
              ~c"~p- fatal: ~p~n",
              [3849, {:illegal_recursion_in_Entity, eName}]
            )
  ...
  defp scan_comment1(~c"--" ++ t, s, _Pos, _Comment, _Acc) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3895, {:invalid_comment, ~c"--" ++ [hd(t)]}]
        )

        :ok
    end

    fatal({:invalid_comment, ~c"--" ++ [hd(t)]}, s)
  end

  defp scan_comment1(~c"\n" ++ t, s = r_xmerl_scanner(line: l), pos, cmt, acc) do
    scan_comment1(t, r_xmerl_scanner(s, line: l + 1, col: 1), pos, cmt, ~c"\n" ++ acc)
  end
  ...
  defp scan_comment1(~c"\r" ++ t, s = r_xmerl_scanner(line: l), pos, cmt, acc) do
    scan_comment1(t, r_xmerl_scanner(s, line: l + 1, col: 1), pos, cmt, ~c"\n" ++ acc)
  end
  ...
  defp scan_markup_completion_gt(t, s) do
    cond do
      ...
      true ->
        :error_logger.error_msg(
          ~c"~p- fatal: ~p~n",
          [3919, {:error, {:malformed_syntax_entity_completion, t}}]
        )
    ...
    case :lists.prefix(pattern, t) do
      ...
      _ ->
        cond do
          ...
          true ->
            :error_logger.error_msg(~c"~p- fatal: ~p~n", [3927, errorMsg])
            :ok
        end
  ...
  defp strip(~c" " ++ t, s = r_xmerl_scanner(col: c), lim) do
    strip(t, r_xmerl_scanner(s, col: c + 1), lim)
  end

  defp strip(~c"\t" ++ _T, s, :no_tab) do
    cond do
      r_xmerl_scanner(s, :quiet) ->
        :ok
  ...
  defp strip(~c"\r" ++ t, s = r_xmerl_scanner(line: l), lim) do
    strip(t, r_xmerl_scanner(s, line: l + 1, col: 1), lim)
  end
  ...
  defp normalize(~c"&" ++ t, s, isNorm) do
  ...
  defp fast_accumulate_whitespace(~c" " ++ t, s, _) do
  ...
  defp fast_accumulate_whitespace(~c"<" ++ _ = r, s, _T) do
  ...
  defp fast_acc_spaces(~c" " ++ t, s, n) do
  ...
  defp fast_acc_end(t, s, n, col, c, cD_I) do
    ...
    try do
      ...
      _, _ ->
        accumulate_whitespace(t, s, line, col, :lists.duplicate(n, c) ++ ~c"\n")
    end
  end
  ...
  defp accumulate_whitespace(~c" " ++ t, s, line, col, acc) do
  ...
  defp accumulate_whitespace(~c"\r" ++ t, s, line, _Col, acc) do
    accumulate_whitespace(t, s, line + 1, 1, [?\n | acc])
  end
  ...
  defp schemaLocations(r_xmlElement(attributes: atts, xmlbase: _Base)) do
    pred = fn
      ...
      r_xmlAttribute(nsinfo: {_, ~c"schemaLocation"}) ->
        false
  ...
  defp fatal_fun(reason) do
    fn s ->
      cond do
        ...
        true ->
          :error_logger.error_msg(~c"~p- fatal: ~p~n", [4134, reason])
          :ok
      end
